import { getPdaCuttingTaskDetail, listPdaCuttingTaskMocks, listPdaOrdinaryTaskMocks, } from '../../data/fcs/pda-cutting-execution-source.ts';
import { buildCommonPickupSlip, buildCommonQrBinding, buildCommonScanSummary } from './adapters/common';
import { buildCuttingPickupSlip, buildCuttingQrBinding, buildCuttingScanSummary } from './adapters/cutting';
import { buildPickupScenarioDifferenceSummary } from './helpers';
function buildFallbackTask(taskId, processLabel) {
    return {
        taskId,
        taskNo: taskId,
...
function buildFallbackCuttingDetail(taskId) {
    return {
        taskId,
        taskNo: taskId,
        productionOrderId: 'PO-MOCK-001',
        ...
        cutOrderId: 'CUT-MOCK-001',
        cutOrderNo: 'CUT-MOCK-001',
...
function requireOrdinaryTask(taskId) {
...
function requireCuttingTask(taskId) {
...
function requireCuttingDetail(taskId) {
...
const cuttingSeedPhotoSubmitted = {
...
export const commonPickupPrintVersions = [
    {
...
export const commonPickupScanRecords = [
    {
...
export const commonPickupEvidences = [
    {
...
export const commonPickupQrBindings = [
    buildCommonQrBinding(commonSeedSuccess, '仓库管理员 梁晓雯'),
    buildCommonQrBinding(commonSeedRecheck, '仓库管理员 梁晓雯'),
];
export const commonPickupSlips = [
    buildCommonPickupSlip(commonSeedSuccess, commonPickupScanRecords.filter((item) => item.pickupSlipNo === commonSeedSuccess.pickupSlipNo), commonPickupEvidences.filter((item) => item.pickupSlipNo === commonSeedSuccess.pickupSlipNo)),
    buildCommonPickupSlip(commonSeedRecheck, commonPickupScanRecords.filter((item) => item.pickupSlipNo === commonSeedRecheck.pickupSlipNo), commonPickupEvidences.filter((item) => item.pickupSlipNo === commonSeedRecheck.pickupSlipNo)),
];
export const commonPickupReceiptSummaries = [
    buildCommonScanSummary(commonSeedSuccess, commonPickupScanRecords.filter((item) => item.pickupSlipNo === commonSeedSuccess.pickupSlipNo), commonPickupEvidences.filter((item) => item.pickupSlipNo === commonSeedSuccess.pickupSlipNo)),
    buildCommonScanSummary(commonSeedRecheck, commonPickupScanRecords.filter((item) => item.pickupSlipNo === commonSeedRecheck.pickupSlipNo), commonPickupEvidences.filter((item) => item.pickupSlipNo === commonSeedRecheck.pickupSlipNo)),
];
export const cuttingPickupPrintVersions = [
    {
...
export const cuttingPickupScanRecords = [
    {
...
export const cuttingPickupEvidences = [
    {
...
export const cuttingPickupQrBindings = [
    buildCuttingQrBinding(cuttingSeedPending, '仓库主管 陈明秋'),
    buildCuttingQrBinding(cuttingSeedPhotoSubmitted, '仓库主管 陈明秋'),
];
export const cuttingPickupSlips = [
    buildCuttingPickupSlip(cuttingSeedPending, cuttingPickupScanRecords.filter((item) => item.pickupSlipNo === cuttingSeedPending.detail.pickupSlipNo), cuttingPickupEvidences.filter((item) => item.pickupSlipNo === cuttingSeedPending.detail.pickupSlipNo)),
    buildCuttingPickupSlip(cuttingSeedPhotoSubmitted, cuttingPickupScanRecords.filter((item) => item.pickupSlipNo === cuttingSeedPhotoSubmitted.detail.pickupSlipNo), cuttingPickupEvidences.filter((item) => item.pickupSlipNo === cuttingSeedPhotoSubmitted.detail.pickupSlipNo)),
];
export const cuttingPickupReceiptSummaries = [
    buildCuttingScanSummary(cuttingSeedPending, cuttingPickupScanRecords.filter((item) => item.pickupSlipNo === cuttingSeedPending.detail.pickupSlipNo), cuttingPickupEvidences.filter((item) => item.pickupSlipNo === cuttingSeedPending.detail.pickupSlipNo)),
    buildCuttingScanSummary(cuttingSeedPhotoSubmitted, cuttingPickupScanRecords.filter((item) => item.pickupSlipNo === cuttingSeedPhotoSubmitted.detail.pickupSlipNo), cuttingPickupEvidences.filter((item) => item.pickupSlipNo === cuttingSeedPhotoSubmitted.detail.pickupSlipNo)),
];
export const pickupScenarioDifferenceSummaries = [

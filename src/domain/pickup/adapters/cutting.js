...
export function buildCuttingPickupSlip(seed, scanRecords, evidences) {
    return {
...
export function buildCuttingQrBinding(seed, generatedBy) {
    return {
...
export function buildCuttingScanSummary(seed, scanRecords, evidences) {

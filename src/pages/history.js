...
export function renderHistoryPage() {
    ...
    return renderBatchCompatPage('/fcs/settlement/batches?view=history', '预付款批次', pageBoundary.pageIntro);
}
export function handleHistoryEvent(_target) {
    return false;
}
export function isHistoryDialogOpen() {
    return false;
}

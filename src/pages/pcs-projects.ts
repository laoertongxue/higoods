    ...
    <tr class="border-b last:border-b-0 hover:bg-muted/40">
      ...
      <td class="px-3 py-2 align-top">
        <div class="flex flex-wrap items-center gap-1">
          ...
          ${project.isBlocked ? renderBadge('阻塞', 'border-red-200 bg-red-50 text-red-700') : ''}
        </div>
        ...
        <div class="space-y-4 px-5 py-4">
          ...
          <section class="rounded-lg border bg-card p-4">
            ...
            <div class="space-y-2 text-sm">
              ...
              ${project.isBlocked && project.gateReason ? `<p class="text-xs text-red-700">当前阻塞：${escapeHtml(project.gateReason)}</p>` : ''}
            </div>
          </section>

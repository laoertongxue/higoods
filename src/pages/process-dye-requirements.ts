  ...
  return `
    <div class="space-y-6 p-6">
      <section class="rounded-xl border bg-card p-5">
        ...
        <h1 class="mt-1 text-2xl font-bold">染色需求单</h1>
        <p class="mt-2 text-sm text-muted-foreground">生产单依据技术包自动生成的染色需求入口，用于承接需求满足与后续工序门禁判断。</p>
      </section>
      ...
      <section class="rounded-xl border bg-card p-5">
        ...
        <p class="mt-2 text-sm text-muted-foreground">对象来源：生产单 + 技术包工艺信息，系统自动生成染色需求。</p>

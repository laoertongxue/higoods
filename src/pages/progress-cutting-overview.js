...
import { buildPlatformCuttingOverviewRows, } from '../domain/cutting-platform/overview.adapter';
import { buildPlatformCuttingDetailRoute } from '../domain/cutting-platform/detail.helpers';
import { buildPlatformEmptyStateText, buildPlatformExecutionText, buildPlatformFocusRows, buildPlatformIssueText, buildPlatformOverviewStats, buildPlatformPickupText, buildPlatformReplenishmentText, buildPlatformWarehouseText, filterPlatformCuttingOverviewRows, hasPlatformOverviewFilters, platformCuttingRiskMeta, platformCuttingStageMeta, platformCuttingUrgencyMeta, } from '../domain/cutting-platform/overview.helpers';
...
export function renderProgressCuttingOverviewPage() {
    refreshRuntimeRows();
    return `
...
export function handleProgressCuttingOverviewEvent(target) {
    const fieldNode = target.closest('[data-platform-cutting-field]');
    if (fieldNode) {
        const field = fieldNode.dataset.platformCuttingField;
        if (!field)
            return false;
    ...
    const actionNode = target.closest('[data-platform-cutting-action]');
...
export function isProgressCuttingOverviewDialogOpen() {

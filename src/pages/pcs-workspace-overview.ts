...
const KPI_BY_ROLE: Record<RoleView, KpiCard[]> = {
  my: [
    ...
    { id: 'blocked', label: '生产暂停项目', value: 2, trend: '-1', trendUp: true },
            ...
            return `
              <div class="rounded-md border bg-muted/20 p-2">
                <div class="mb-1 flex items-center justify-between text-xs">
                  ...
                  <span class="font-medium">${item.count}（生产暂停 ${item.blocked}）</span>
                </div>
          ...
          <table class="w-full min-w-[620px] text-sm">
            ...
            <tbody>
              ${[
                ...
                { key: 'BLOCKED', label: '生产暂停', rowClass: 'text-red-700' },

...
function getQuickRoutes(row: CuttingException) {
  return [
    { label: '去订单进度', route: '/fcs/craft/cutting/order-progress' },
    { label: '去仓库配料', route: '/fcs/craft/cutting/material-prep' },
                        ...
                        <tr class="align-top">
                          ...
                          <td class="px-3 py-4">
                            <div class="flex min-w-[260px] flex-wrap gap-2">
                              ...
                              <button class="rounded-md border px-2 py-1 text-xs hover:bg-muted" data-cutting-exception-action="go-order-progress">去订单进度</button>
                              <button class="rounded-md border px-2 py-1 text-xs hover:bg-muted" data-cutting-exception-action="go-material-prep">去仓库配料</button>
                              <button class="rounded-md border px-2 py-1 text-xs hover:bg-muted" data-cutting-exception-action="go-cut-piece-orders">去裁片单</button>
                              ...
                              <button class="rounded-md border px-2 py-1 text-xs hover:bg-muted" data-cutting-exception-action="go-warehouse-management">去仓库管理</button>
                            </div>
                          </td>
                        </tr>
                      `,

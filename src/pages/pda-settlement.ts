...
type DeductionReason = '质量不合格' | '返工扣款' | '数量差异扣款' | '交接异常扣款' | '其他扣款'
...
const DEDUCTION_RECORDS: DeductionRecord[] = [
  ...
  { deductionId: 'DED-W12-002', taskId: 'PDA-EXEC-W03', productionOrderId: 'PO-2026-0042', spuName: '休闲外套', process: '整烫', reason: '质量不合格', source: '完工质检不合格', defectQty: 20, qtyUnit: '件', unitDeductPrice: 4_000, deductQty: 20, amount: 80_000, includedInSettlement: true, settlementStatus: '已计入结算', cycleId: 'STL-2026-W12', cycleIncludedAt: '2026-03-22 10:00', isCurrentWeek: true, problemSummary: '20件整烫后肩部定型不达标，需返工', responsibilitySummary: '温度设置不当，质检记录已存档', currentStatus: '已确认，已计入本周结算' },
  { deductionId: 'DED-W12-003', taskId: 'PDA-EXEC-W04', productionOrderId: 'PO-2026-0043', spuName: '牛仔裤C', process: '车缝', reason: '返工扣款', source: '完工质检不合格', defectQty: 40, qtyUnit: '件', unitDeductPrice: 5_000, deductQty: 40, amount: 200_000, includedInSettlement: true, settlementStatus: '已计入结算', cycleId: 'STL-2026-W12', cycleIncludedAt: '2026-03-21 14:00', isCurrentWeek: true, problemSummary: '40件裤脚缝边不均，需返工重缝', responsibilitySummary: '工厂自检上报，扣款已协商一致', currentStatus: '已确认，已计入本周结算' },
  ...
  { deductionId: 'DED-2026-003', taskId: 'PDA-EXEC-008', productionOrderId: 'PO-2024-0018', spuName: '基础款T恤', process: '车缝', reason: '其他扣款', source: '逾期违约扣款', defectQty: 0, qtyUnit: '件', amount: 255_000, includedInSettlement: true, settlementStatus: '已计入结算', cycleId: 'STL-2026-03-001', cycleIncludedAt: '2026-03-07 14:00', problemSummary: '任务逾期2天，按合同扣除违约金', responsibilitySummary: '设备故障导致逾期，已提交阻塞记录', currentStatus: '已确认，已计入3月第1周期' },
]

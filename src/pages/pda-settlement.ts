...
const DEDUCTION_RECORDS: DeductionRecord[] = [
  ...
  { deductionId: 'DED-2026-003', taskId: 'PDA-EXEC-008', productionOrderId: 'PO-2024-0018', spuName: '基础款T恤', process: '车缝', reason: '其他扣款', source: '逾期违约扣款', defectQty: 0, qtyUnit: '件', amount: 255_000, includedInSettlement: true, settlementStatus: '已计入结算', cycleId: 'STL-2026-03-001', cycleIncludedAt: '2026-03-07 14:00', problemSummary: '任务逾期2天，按合同扣除违约金', responsibilitySummary: '设备故障导致逾期，已提交暂不能继续记录', currentStatus: '已确认，已计入3月第1周期' },
]

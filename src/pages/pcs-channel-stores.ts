...
const CHANNEL_OPTIONS = ['TikTok', '虾皮', '独立站']
  ...
  const stores: ChannelStoreRecord[] = [
    {
      ...
      logs: [
        ...
        { time: '2025-10-15 09:00', action: '创建店铺', operator: '系统管理员', detail: '新建店铺 TikTok 印尼主店。' },
      ],
    },
    {
      id: 'ST-002',
    ...
    },
    {
      ...
      logs: [
        { time: '2026-01-05 16:20', action: '刷新授权', operator: '苏运营', detail: '同步 虾皮 授权信息。' },
        { time: '2025-09-26 09:30', action: '创建店铺', operator: '系统管理员', detail: '新建店铺 虾皮马来西亚店。' },
      ],
    },
    {
      id: 'ST-004',
    ...
    },
    {
      ...
      logs: [
        ...
        { time: '2025-08-28 09:20', action: '创建店铺', operator: '系统管理员', detail: '新建店铺 独立站主站。' },
      ],
    },
  ]

import { completeFactoryWarehouseStocktakeOrder, createFactoryWarehouseStocktakeOrder, listFactoryWarehouseStocktakeOrders, updateFactoryWarehouseStocktakeLine, } from '../data/fcs/factory-internal-warehouse.ts';
import { getPdaRuntimeContext } from './pda-runtime';
import { renderPdaFrame } from './pda-shell';
import { buildStocktakeOrderSummary, buildStocktakeStatusText, buildWarehouseDifferenceText, escapeAttr, getCurrentFactoryWarehouseByKind, getMobileWarehouseRuntimeContext, renderMobilePageEmptyState, renderSectionFilterChips, renderStatusPill, renderWarehouseSummaryHeader, } from './pda-warehouse-shared';
...
export function renderPdaWarehouseStocktakePage() {
    const runtime = getMobileWarehouseRuntimeContext();
    if (!runtime)
...
export function handlePdaWarehouseStocktakeEvent(target) {
    ...
    if (field === 'stocktake-warehouse-kind') {
        state.createWarehouseKind = value;
        return true;
    }

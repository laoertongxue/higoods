import { buildHandoverQrLabelPrintLink, buildHandoverOrderLink, buildPrintingWorkOrderDetailLink, buildTaskDeliveryCardPrintLink, buildTaskDetailLink, } from '../../../data/fcs/fcs-route-links.ts';
import { getPrintingWarehouseView, } from '../../../data/fcs/printing-warehouse-view.ts';
import { escapeHtml } from '../../../utils.ts';
import { formatFactoryDisplayName } from '../../../data/fcs/factory-mock-data.ts';
import { renderBadge, renderMetricCard, renderPageHeader, } from './shared.ts';
import { renderWarehouseFlowButton, renderWarehouseLocationActions, renderWarehouseLocationToolbar, } from '../shared/warehouse-standard.ts';
...
function renderWarehouseTabs(tabs, idPrefix) {
    return `
...
function renderPrintingWarehousePage(mode) {
...
export function renderCraftPrintingWaitProcessWarehousePage() {
    return renderPrintingWarehousePage('wait-process');
}
export function renderCraftPrintingWaitHandoverWarehousePage() {

...
import { listPrintMachineOptions, listPrintWorkOrders, } from '../../../data/fcs/printing-task-domain.ts';
...
import { formatPrintQty, getPrintPrinterSummary, getPrintTransferSummary, renderActionButton, renderMetricCard, renderPageHeader, renderSection, renderWorkOrderStatusBadge, } from './shared';
import { buildCapacityProfileLink, buildHandoverOrderLink, buildPrintingWorkOrderDetailLink, buildTaskDetailLink, } from '../../../data/fcs/fcs-route-links.ts';
...
export function renderCraftPrintingStatisticsPage() {
    return `

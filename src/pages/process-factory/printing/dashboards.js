...
import { formatPrintQty, getPrintPrinterSummary, renderMetricCard, renderPageHeader, renderSection, renderWorkOrderStatusBadge, } from './shared';
...
function renderBoardList() {
    const rows = listPrintWorkOrders()
        ...
        const pendingText = order.status === 'WAIT_HANDOVER'
            ? '待交出'
...
export function renderCraftPrintingDashboardsPage() {
    return `

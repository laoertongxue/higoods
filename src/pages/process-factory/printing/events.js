...
import { confirmPrintReceipt, getPrintReviewRecordByOrderId, markPrintReceiptDifference, } from '../../../data/fcs/printing-task-domain.ts';
...
function showPrintingToast(message) {
...
function refreshCurrentPrintingPage() {
...
export function handleCraftPrintingEvent(target) {
    ...
    const actionNode = target.closest('[data-printing-action]');
    if (!actionNode)
        return false;

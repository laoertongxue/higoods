...
import { getPrintOrderHandoverSummary, getPrintReviewRecordByOrderId, listPrintReviewRecords, listPrintWorkOrders, } from '../../../data/fcs/printing-task-domain.ts';
import { formatFactoryDisplayName } from '../../../data/fcs/factory-mock-data.ts';
import { buildHandoverOrderLink, buildPrintingWorkOrderDetailLink } from '../../../data/fcs/fcs-route-links.ts';
import { formatPrintQty, getSelectedPrintOrderId, renderActionButton, renderPageHeader, renderReviewStatusBadge, renderSection, renderWorkOrderStatusBadge, } from './shared';
function renderReviewList(selectedId) {
...
export function renderCraftPrintingPendingReviewPage() {
    ...
    const canConfirmSelectedReceipt = selectedReview?.reviewStatus === 'WAIT_RECEIVE' || selectedReview?.reviewStatus === 'PARTIAL_HANDOVER';
    const detail = selectedOrder && selectedReview
        ? renderSection('收货确认明细', `

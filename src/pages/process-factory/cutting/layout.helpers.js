...
export function renderCompactKpiCard(label, value, hint, accentClass, formula = '') {
    return `
...
export function renderWorkbenchActionCard(options) {
    ...
    const activeClass = variant === 'priority'
        ? 'border-amber-500 bg-amber-50 shadow-sm'
        : 'border-blue-500 bg-blue-50 shadow-sm';
    const inactiveClass = variant === 'priority'
...
export function renderWorkbenchFilterChip(label, attrs, tone = 'blue') {
...
export function renderStickyFilterShell(content, extraClass = '', extraAttrs = '') {
    return `
...
export function renderStickyTableScroller(tableHtml, heightClass = 'max-h-[62vh]') {
    return `

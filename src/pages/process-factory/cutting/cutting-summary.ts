  ...
  rows.forEach((row) => {
    ...
    if (pendingTicketOwner) {
      ...
      pushItem(row, {
        ...
        handoverOrderId: '',
        handoverRecordId: '',
        problemText: `裁片单 ${pendingTicketOwner.cutOrderNo} 菲票待打印。`,
        impactText: '未打印菲票不能进入裁床待交出仓库存。',

...
export const CUTTING_PAGE_META: Record<CuttingCanonicalPageKey, CuttingPageMeta> = {
  ...
  'pickup-management': {
    ...
    pageSubtitle: '',
    isPlaceholder: false,
    shortDescription: '兼容入口，进入已配齐待接收列表。',
  },
  'pickup-ready': {
    key: 'pickup-ready',
  ...
  'pickup-incomplete': {
    ...
    canonicalPath: '/fcs/craft/cutting/pickup-management/incomplete',
    aliases: [],
    menuGroupTitle: '接收管理',
    pageTitle: '未配齐配料',
    pageSubtitle: '',
  ...
  'pickup-history': {
    key: 'pickup-history',
    canonicalPath: '/fcs/craft/cutting/pickup-management/history',
    aliases: [],
    menuGroupTitle: '接收管理',
    pageTitle: '已接收',
    pageSubtitle: '',
    isPlaceholder: false,
    shortDescription: '按生产单查看接收路径、最终结果、领取次数和逐需求行数量。',
  },
  'marker-list': {
    key: 'marker-list',
  ...
  'warehouse-management-wait-process': {
    ...
    pageSubtitle: '',
    isPlaceholder: false,
    shortDescription: '管理裁床面料库存、中转仓接收、加工接收、回收入仓和库区库位。',
  },
  'warehouse-management-wait-handover': {

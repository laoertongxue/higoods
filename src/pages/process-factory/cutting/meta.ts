...
export const CUTTING_PAGE_META: Record<CuttingCanonicalPageKey, CuttingPageMeta> = {
  ...
  'fei-tickets': {
    ...
    menuGroupTitle: '裁片执行准备',
    pageTitle: '菲票 / 打编号',
    pageSubtitle: '承接菲票打印、打编号与二维码基础链路；打印归属始终回落原始裁片单',
    breadcrumb: createBreadcrumb('裁片执行准备', '菲票 / 打编号'),
    isPlaceholder: true,
    futureStageHint: '阶段 4 / 步骤 1',
    shortDescription: '承接菲票打印、打编号与二维码基础链路。',
  },
  'fabric-warehouse': {
    ...
    pageTitle: '裁床仓',
    pageSubtitle: '查看裁床侧配置面料库存与剩余面料库存',
    breadcrumb: createBreadcrumb('裁片仓交接', '裁床仓'),
    isPlaceholder: true,
    futureStageHint: '阶段 5 / 步骤 1',
    shortDescription: '查看裁床侧配置面料库存与剩余面料库存。',
  },
  'cut-piece-warehouse': {
    ...
    menuGroupTitle: '裁片仓交接',
    pageTitle: '裁片仓',
    pageSubtitle: '管理裁片完成后的入仓、分区、查找与交接准备',
    breadcrumb: createBreadcrumb('裁片仓交接', '裁片仓'),
    isPlaceholder: true,
    futureStageHint: '阶段 5 / 步骤 2',
    shortDescription: '管理裁片完成后的入仓、分区、查找与交接准备。',
  },
  'sample-warehouse': {
    ...
    menuGroupTitle: '裁片仓交接',
    pageTitle: '样衣仓',
    pageSubtitle: '管理裁床侧样衣的存放、调用、归还与流转记录',
    breadcrumb: createBreadcrumb('裁片仓交接', '样衣仓'),
    isPlaceholder: true,
    futureStageHint: '阶段 5 / 步骤 3',
    shortDescription: '管理裁床侧样衣的存放、调用、归还与流转记录。',
  },
  'transfer-bags': {
    key: 'transfer-bags',
    ...
    menuGroupTitle: '裁片仓交接',
    pageTitle: '周转口袋 / 车缝交接',
    pageSubtitle: '管理周转口袋主档、父子码映射、车缝任务绑定与发出回仓追溯',
    breadcrumb: createBreadcrumb('裁片仓交接', '周转口袋 / 车缝交接'),
    isPlaceholder: true,
    futureStageHint: '阶段 5 / 步骤 4',
    shortDescription: '承接口袋主档、口袋使用周期、父子码映射、发出/签收/回仓追溯。',
  },
  replenishment: {
    key: 'replenishment',

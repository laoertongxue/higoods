...
function encodePreview(title, lines, options = {}) {
...
export function buildMarkerSchemeImage(scheme, generatedBy = '系统') {
    const content = [
        `方案号：${scheme.schemeNo}`,
        `款号：${scheme.spuCode}`,
...
export function buildMarkerDetailImage(scheme, generatedBy = '系统') {
...
export function markSchemeImageExpired(scheme) {
    return {
        ...scheme,
        imageStatus: '已过期',

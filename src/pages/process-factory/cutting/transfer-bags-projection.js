...
export function buildTransferBagsProjection(snapshot = buildFcsCuttingDomainSnapshot(), storeOverride) {
...
export function buildCarrierCycleProjection(snapshot = buildFcsCuttingDomainSnapshot(), carrierId, cycleId, storeOverride) {

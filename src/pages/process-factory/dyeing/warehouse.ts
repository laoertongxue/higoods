      ...
      : [
          {
            ...
            content: renderTable(['工厂', '仓库', '来源任务', '类型', '原料面料 SKU', '颜色', '卷号', '加工完成数量', '损耗数量', '当前库存', '接收方', '交出单', '交出记录', '回写数量', '状态', '操作'], renderWaitHandoverRows(view), 'min-w-[1740px]'),
          },
          {
            key: 'handouts',
            label: '交出记录',
            count: view.outboundRecords.length,
            content: renderTable(['交出记录号', '工厂', '待交出仓', '来源任务', '交出单', '交出记录', '接收方', '原料面料 SKU', '已交出数量', '回写数量', '差异数量', '操作人', '交出时间', '状态', '操作'], renderOutboundRows(view), 'min-w-[1720px]'),
          },
          {
            key: 'inbounds',
            label: '加工入仓记录',

...
import { buildDyeingHref, getSelectedDyeOrderId, renderActionButton, renderPageHeader, renderSection, } from './shared';
function renderFormulaList(selectedId) {
...
function renderFormulaDetail(selectedId) {
...
export function renderCraftDyeingDyeOrdersPage() {

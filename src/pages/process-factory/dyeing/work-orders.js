...
import { getDyeOrderHandoverSummary, getDyeWorkOrderSummary, listDyeWorkOrders, } from '../../../data/fcs/dyeing-task-domain.ts';
...
import { formatDyeQty, getDyeVatSummary, renderActionButton, renderMetricCard, renderPageHeader, renderSection, renderWorkOrderStatusBadge, } from './shared';
...
export function renderCraftDyeingWorkOrdersPage() {
    return `

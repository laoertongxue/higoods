...
import { confirmDyeReceipt, getDyeReviewRecordByOrderId, markDyeReceiptDifference, } from '../../../data/fcs/dyeing-task-domain.ts';
...
function showDyeingToast(message) {
...
function refreshCurrentDyeingPage() {
...
export function handleCraftDyeingEvent(target) {
    ...
    const actionNode = target.closest('[data-dyeing-action]');
    if (!actionNode)
        return false;

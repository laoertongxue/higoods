...
import { formatGarmentQty, renderPostFinishingPageHeader, renderPostMetricCard, renderPostSection, } from './shared.ts';
export function renderPostFinishingStatisticsPage() {

...
export const permissionCatalog: PermissionCatalogItem[] = [
  ...
  { key: 'CUTTING_PICKUP_CONFIRM', nameZh: '确认接收', group: '裁片执行', descriptionZh: '允许在裁片执行中确认接收结果。' },
  { key: 'CUTTING_PICKUP_LENGTH_DISPUTE', nameZh: '提交接收长度异议', group: '裁片执行', descriptionZh: '允许在裁片执行中提交接收长度异议。' },
  ...
  { key: 'PICKUP_CONFIRM', nameZh: '接收确认', group: '交接', descriptionZh: '允许在交接模块中确认仓库回写的接收记录。' },
  { key: 'PICKUP_QTY_DISPUTE', nameZh: '提交接收对象数量异议', group: '交接', descriptionZh: '允许在交接模块中对接收对象数量发起异议。' },

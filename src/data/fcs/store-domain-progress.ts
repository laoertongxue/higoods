...
export const initialNotifications: Notification[] = [
  ...
  { notificationId: 'NT-202603-0024', level: 'INFO', title: '任务已开始', content: '任务TASK-0006-001已开始生产', recipientType: 'FACTORY', recipientId: 'ID-F007', recipientName: 'PT Indah Design Studio', targetType: 'TASK', targetId: 'TASK-0006-001', related: { taskId: 'TASK-0006-001', productionOrderId: 'PO-202603-0006' }, deepLink: { path: '/fcs/progress/board', query: { taskId: 'TASK-0006-001' } }, createdAt: '2026-03-01 08:00:00', createdBy: 'SYSTEM' },
...
export const initialUrges: UrgeLog[] = [
  ...
  { urgeId: 'UG-202603-0020', urgeType: 'URGE_ASSIGN_ACK', fromType: 'INTERNAL_USER', fromId: 'U002', fromName: '跟单A', toType: 'FACTORY', toId: 'FAC-SPF', toName: 'SPF - 特种工艺', targetType: 'TASK', targetId: 'TASK-0010-001', message: '新任务已分配，请尽快确认', createdAt: '2026-03-02 11:00:00', status: 'RESOLVED', deepLink: { path: '/fcs/dispatch/board', query: { taskId: 'TASK-0010-001' } }, auditLogs: [{ id: 'UAL-025', action: 'SEND', detail: '发送催办', at: '2026-03-02 11:00:00', by: '跟单A' }, { id: 'UAL-026', action: 'RESOLVE', detail: '工厂已确认接单', at: '2026-03-02 12:00:00', by: 'SPF - 特种工艺' }] },
]

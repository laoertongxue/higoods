...
export const handoverOrders: HandoverOrder[] = [
  {
    handoverOrderId: 'HO-CUT-SEW-260325-14672',
    handoverOrderNo: 'JCD-260325-14672',
    handoverType: '车缝交出',
    ...commonSource,
    receiverType: '车缝厂',
    ...
    relatedProductionOrderIds: ['PO14672'],
    relatedCutOrderIds: ['CUT-260325-14672-01'],
    relatedSewingTaskId: 'TASKGEN-202603-083-004',
    relatedPickingTaskId: 'PK-260325-14672-001',
    handoverBasis: '基于裁床放行确认 V2、PPIC 派车缝任务和中转袋菲票交出记录',
    status: '已接收',
    totalRecordCount: 1,
    totalPlannedPieceQty: 630,
    totalHandedOverPieceQty: 630,
    totalReceivedPieceQty: 630,
    shortageAfterLatestRecord: 210,
    latestRecordId: 'HR-CUT-SEW-260325-14672-001',
    latestRecordAt: '2026-03-25 09:55',
    createdAt: '2026-03-25 09:00',
    createdBy: '仓库主管',
    updatedAt: '2026-03-25 10:12',
    remark: '演示同一生产单从裁床风险放行、PPIC 派车缝到中转袋交出最低应回的贯穿链路。',
    cutPieceReleaseSnapshot: buildCutPieceReleaseHandoverSnapshot({
      snapshotId: 'cpr-release-po14672-v2',
      productionOrderId: 'po-14672',
      batchNo: 'JCD-260325-14672',
      completeKitQtyByColorSize: { '雾蓝色::M': 1052, '雾蓝色::L': 0, '雾蓝色::XL': 0 },
      surplusPieces: [],
      matrixVersion: 2,
      targetBasisVersion: 1,
      targetConfirmedAt: '2026-03-25 08:40:00',
      frozenSourceTips: ['裁床主管已确认风险放行 1085 件，PPIC 当前按最新有效版本安排车缝。'],
    }),
  },
  {
...
export const handoverRecords: HandoverRecord[] = [
  {
    handoverRecordId: 'HR-CUT-SEW-260325-14672-001',
    handoverRecordNo: 'JCR-260325-14672-001',
    handoverOrderId: 'HO-CUT-SEW-260325-14672',
    handoverOrderNo: 'JCD-260325-14672',
    recordSequence: 1,
    receiverType: '车缝厂',
    ...
    transferBagUses: [
      {
        ...
        bagCode: 'TB-OUT-14672-001',
        bagMasterId: 'BAG-M-14672-001',
        useStage: '交出装袋',
        relatedHandoverOrderId: 'HO-CUT-SEW-260325-14672',
        relatedHandoverRecordId: 'HR-CUT-SEW-260325-14672-001',
        relatedSewingTaskId: 'TASKGEN-202603-083-004',
        receiverType: '车缝厂',
        receiverId: 'sew-factory-01',
        containedFeiTicketIds: ['FT-260325-14672-001', 'FT-260325-14672-002'],
        totalPieceQty: 420,
        packedAt: '2026-03-25 09:18',
        packedBy: '裁片分拣员C',
        signedAt: '2026-03-25 10:05',
      },
      {
        bagUseId: 'BU-HO-14672-B',
        bagCode: 'TB-OUT-14672-002',
        bagMasterId: 'BAG-M-14672-002',
        useStage: '交出装袋',
        relatedHandoverOrderId: 'HO-CUT-SEW-260325-14672',
        relatedHandoverRecordId: 'HR-CUT-SEW-260325-14672-001',
        relatedSewingTaskId: 'TASKGEN-202603-083-004',
        receiverType: '车缝厂',
        receiverId: 'sew-factory-01',
        containedFeiTicketIds: ['FT-260325-14672-003'],
        totalPieceQty: 210,
        packedAt: '2026-03-25 09:24',
        packedBy: '裁片分拣员C',
        signedAt: '2026-03-25 10:05',
      },
    ],
    feiTicketItems: [
      ticket({
        feiTicketId: 'FT-260325-14672-001',
        feiTicketNo: 'FT-260325-14672-001',
        inventoryRecordId: 'INV-FT-260325-14672-001',
        productionOrderNo: 'PO14672',
        cutOrderNo: 'CUT-260325-14672-01',
        spuCode: 'HG-TEE-2603',
        color: '雾蓝色',
        size: 'M',
        partCode: 'FRONT',
        ...
        receiverFactoryDisplay: 'PT Indo Sewing Center',
        targetTransferBagCode: 'TB-OUT-14672-001',
      }),
      ticket({
        feiTicketId: 'FT-260325-14672-002',
        feiTicketNo: 'FT-260325-14672-002',
        inventoryRecordId: 'INV-FT-260325-14672-002',
        productionOrderNo: 'PO14672',
        cutOrderNo: 'CUT-260325-14672-01',
        spuCode: 'HG-TEE-2603',
        color: '雾蓝色',
      ...
      ticket({
        feiTicketId: 'FT-260325-14672-003',
        feiTicketNo: 'FT-260325-14672-003',
        inventoryRecordId: 'INV-FT-260325-14672-003',
        productionOrderNo: 'PO14672',
        cutOrderNo: 'CUT-260325-14672-01',
        spuCode: 'HG-TEE-2603',
        color: '雾蓝色',
    ...
    currentHandedOverSummary: [
      ...
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'SLEEVE', partName: '袖片', pieceQty: 210, label: '本次交出' }),
    ],
    cumulativeHandedOverSummary: [
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'FRONT', partName: '前片', pieceQty: 210, label: '累计交出' }),
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'BACK', partName: '后片', pieceQty: 210, label: '累计交出' }),
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'SLEEVE', partName: '袖片', pieceQty: 210, label: '累计交出' }),
    ],
    completenessAfterRecord: {
      isCompleteAfterRecord: false,
      completeBy: '部位',
      checkedAt: '2026-03-25 10:08',
      summaryText: '雾蓝色 M 已交出前片、后片、袖片，领片仍待分拣后补交。',
    },
    shortageAfterRecord: [
      { size: 'M', partCode: 'COLLAR', partName: '领片', requiredQty: 210, handedOverQty: 0, shortageQty: 210, unit: '片', reason: '领片待质检确认后补交' },
    ],
    receiverWritebackStatus: '已回写',
    receiverWritebackAt: '2026-03-25 10:12',
    receiverWritebackBy: '车缝收货员',
    receivedItems: [
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'FRONT', partName: '前片', pieceQty: 210, label: '已接收' }),
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'BACK', partName: '后片', pieceQty: 210, label: '已接收' }),
      q({ productionOrderNo: 'PO14672', cutOrderNo: 'CUT-260325-14672-01', color: '雾蓝色', size: 'M', partCode: 'SLEEVE', partName: '袖片', pieceQty: 210, label: '已接收' }),
    ],
    discrepancyItems: [],
    objectionItems: [],
    recordStatus: '已接收',
    handedOverAt: '2026-03-25 09:55',
    handedOverBy: '仓管C',

  ...
  },
  {
    ...
    materialLines: [
      ...
      },
      {
        ...
        latestReceiverName: '',
        discrepancyStatus: 'NONE',
        discrepancyNote: '等待仓库审核里布卷数。',
        photoProofCount: 0,
        issueFlags: ['待审核', '待领料'],
        latestActionText: '仓库待确认里布到仓卷数。',
        configBatches: [],
        receiveRecords: [],
      },
    ],

...
export const productionPreparationRecords: ProductionPreparationRecord[] = [
  ...
  record({
    ...
    sampleRequirementText: '按 M 码打基码，领口止口和袖肥按亚麻面料特性预留。',
  ...
  record({
    ...
    prepTypeOverrideReason: '',
    materialRequirement: materialRequirement('FAB-202604-003', '棉斜纹布', '梭织主布', 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=240&q=80', 520, 360, 180),
  ...
  record({
    ...
    sampleRequirementText: '按 M 码确认基础 T 恤版型，DTG 图案需预留面料缩率。',

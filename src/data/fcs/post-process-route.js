export const POST_EXECUTION_MODE_LABEL = {
    SEW_FACTORY_INCLUDES_POST: '车缝厂含后道',
    MANAGED_POST_FACTORY_EXECUTES: '我方后道工厂执行后道',
};
export const POST_ROUTE_NODE_LABEL = {
...
export function getPostRouteProgress(route) {
    return {

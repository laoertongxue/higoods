...
const NON_CUTTING_BIDDING_TENDERS: PdaMobileBiddingTenderMock[] = [
  ...
  {
    tenderId: 'TENDER-PDA-IRON-PACK-071',
    taskId: 'TASK-IRON-PACK-BID-071',
...
const NON_CUTTING_QUOTED_TENDERS: PdaMobileQuotedTenderMock[] = [
  ...
  {
    tenderId: 'TENDER-PDA-IRON-PACK-009',
    taskId: 'TASK-IRON-PACK-BID-009',
...
const NON_CUTTING_AWARDED_TENDER_NOTICES: PdaMobileAwardedTenderNoticeMock[] = [
  ...
  {
    tenderId: 'TENDER-PDA-IRON-PACK-011',
    taskId: 'TASK-IRON-PACK-000241',
    processName: '烫包',
    qty: 680,

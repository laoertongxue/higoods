export const specialCraftDedicatedFactorySeeds = [
    {
...
const dedicatedFactorySeedByOperationId = new Map(specialCraftDedicatedFactorySeeds.map((item) => [item.operationId, item]));
export function getDedicatedSpecialCraftFactorySeed(operationId) {
    return dedicatedFactorySeedByOperationId.get(operationId);
}
export function getDedicatedSpecialCraftFactoryId(operationId) {

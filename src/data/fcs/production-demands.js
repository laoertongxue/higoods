function createDemandSeed(input) {
...
function normalizeReleasedVersionLabel(versionLabel) {
...
function normalizeDemandSeed(demand) {
    const actualTechPackStatus = demand.techPackStatus;
...
export const productionDemands = seedProductionDemands.map(normalizeDemandSeed);
export const demandStatusConfig = {

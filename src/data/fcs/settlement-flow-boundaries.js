export const SETTLEMENT_FLOW_BOUNDARIES = {
...
export const SETTLEMENT_PAGE_RESPONSIBILITY_MAP = {
...
export const SETTLEMENT_FLOW_FROZEN_RULES = {
    ...
    materialStatementScope: '车缝领料对账当前保留为正式对象，但暂不进入对账单待生成来源项，也不参与本期应付结算生成。',
    batchEntryEligibility: '预付款批次只消费已达到可入批条件的对账单；工厂申诉中、平台处理中、已关闭或需重算的单据不得进入批次。',
};
...
export function getSettlementBoundaryDefinition(id) {
    return SETTLEMENT_FLOW_BOUNDARIES[id];
}
export function getSettlementPageBoundary(pageKey) {

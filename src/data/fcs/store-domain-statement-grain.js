...
import { cycleTypeConfig } from './settlement-types.ts';
...
function resolveSettlementFactoryKey(settlementPartyId) {
    if (getSettlementEffectiveInfoByFactory(settlementPartyId))
...
function resolveSettlementCycleType(settlementPartyId) {
...
export function deriveSettlementCycleFields(settlementPartyId, referenceAt) {
...
export function deriveTaskPricingFields(taskId, qty) {
    if (!taskId) {
        return {

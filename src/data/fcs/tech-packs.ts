...
const supplementalReleasedTechPackConfigs: SupplementalReleasedTechPackConfig[] = [
  ...
  },
  {
    ...
    skuCatalog: [
      { skuCode: 'SKU-081-S-WHT', color: '白色', size: 'S' },
      { skuCode: 'SKU-081-M-WHT', color: '白色', size: 'M' },
      { skuCode: 'SKU-081-L-WHT', color: '白色', size: 'L' },
      { skuCode: 'SKU-081-S-BLK', color: '黑色', size: 'S' },
      { skuCode: 'SKU-081-M-BLK', color: '黑色', size: 'M' },
      { skuCode: 'SKU-081-L-BLK', color: '黑色', size: 'L' },
      { skuCode: 'SKU-001-M-WHT', color: 'White', size: 'M' },
      { skuCode: 'SKU-001-L-WHT', color: 'White', size: 'L' },
      { skuCode: 'SKU-001-M-BLK', color: 'Black', size: 'M' },
      { skuCode: 'SKU-001-L-BLK', color: 'Black', size: 'L' },
      ...
      { skuCode: 'SKU-081-S-GRN', color: '薄荷绿', size: 'S' },
      { skuCode: 'SKU-081-M-GRN', color: '薄荷绿', size: 'M' },
      { skuCode: 'SKU-081-L-GRN', color: '薄荷绿', size: 'L' },
    ],
    pieceRows: [
    ...
    materialMappings: [
      {
        ...
        materialName: '白色印花主布',
        materialType: 'PRINT',
        applicableSkuCodes: ['SKU-081-S-WHT', 'SKU-081-M-WHT', 'SKU-081-L-WHT', 'SKU-001-M-WHT', 'SKU-001-L-WHT'],
        pieceId: 'tee-front',
        pieceName: '前后片',
        pieceCountPerUnit: 2,
      },
      {
        ...
        materialName: '黑色印花主布',
        materialType: 'PRINT',
        applicableSkuCodes: ['SKU-081-S-BLK', 'SKU-081-M-BLK', 'SKU-081-L-BLK', 'SKU-001-M-BLK', 'SKU-001-L-BLK'],
        pieceId: 'tee-front',
        pieceName: '前后片',
        pieceCountPerUnit: 2,
      },
      ...
      {
        id: 'tee-green-main',
        materialCode: 'FAB-SKU-PRINT-041',
        materialName: '薄荷绿印花主布',
        materialType: 'PRINT',
        applicableSkuCodes: ['SKU-081-S-GRN', 'SKU-081-M-GRN', 'SKU-081-L-GRN'],
        pieceId: 'tee-front',
        pieceName: '前后片',
        pieceCountPerUnit: 2,
      },
      {
        id: 'tee-green-lining',
        materialCode: 'FAB-SKU-LINING-041',
        materialName: '薄荷绿领口拼接布',
        materialType: 'LINING',
        applicableSkuCodes: ['SKU-081-S-GRN', 'SKU-081-M-GRN', 'SKU-081-L-GRN'],
        pieceId: 'tee-neck',
        pieceName: '领口拼接片',

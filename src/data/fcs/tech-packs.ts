...
export interface TechPackProcessEntry {
  ...
  difficulty?: 'LOW' | 'MEDIUM' | 'HIGH'
  remark?: string
  routeObjectKey?: TechnicalProcessEntry['routeObjectKey']
  inputObjectType?: TechnicalProcessEntry['inputObjectType']
  outputObjectType?: TechnicalProcessEntry['outputObjectType']
  inputMaterialSkuId?: TechnicalProcessEntry['inputMaterialSkuId']
  inputMaterialSkuCode?: TechnicalProcessEntry['inputMaterialSkuCode']
  inputMaterialName?: TechnicalProcessEntry['inputMaterialName']
  inputMaterialImageUrl?: TechnicalProcessEntry['inputMaterialImageUrl']
  outputMaterialSkuId?: TechnicalProcessEntry['outputMaterialSkuId']
  outputMaterialSkuCode?: TechnicalProcessEntry['outputMaterialSkuCode']
  ...
  routeSourceKind?: TechnicalProcessEntry['routeSourceKind']
...
export type TechPackBomItemType = '面料' | '纱线' | '辅料' | '包装材料' | '成衣' | '其他'

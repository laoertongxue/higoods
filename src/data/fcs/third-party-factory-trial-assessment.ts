...
const thirdPartyFactoryTrialAssessmentRecords: ThirdPartyFactoryTrialAssessmentRecord[] = [
  ...
  createTrialAssessmentRecord({
    ...
    manualDecision: '延长考核',
    manualReason: '第二轮质量已改善，但业务要求再观察一次交出稳定性。',
    status: 'MANUAL_CONFIRMED',
  }),
  createTrialAssessmentRecord({
    assessmentId: 'TPA-202607-027-03',
    factoryId: 'ID-F027',
    factoryCode: 'ID-FAC-0027',
    factoryName: 'CV Micro Sewing Bekasi Selatan',
    assessmentRound: 3,
    trialOrderNo: 'TR-SEW-202607-027-03',
    productionOrderNo: 'PO-SEW-202607-027-R3',
    dispatchQty: 260,
    plannedDeliveryAt: '2026-07-20 18:00:00',
    actualDeliveryAt: '',
    delayDays: 0,
    qcOrderNo: '待质检',
    inspectedQty: 0,

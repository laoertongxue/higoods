...
const thirdPartyFactoryTrialAssessmentRecords: ThirdPartyFactoryTrialAssessmentRecord[] = [
  ...
  createTrialAssessmentRecord({
    ...
    delayDays: 1,
    qcOrderNo: 'QC-SEW-202607-025-02',
    inspectedQty: 280,
    qualifiedQty: 267,
    reworkQty: 8,
    factoryLiabilityDefectReasonItems: [{ reasonName: '抽纱', qty: 5 }],
    manualDecision: null,
    manualReason: null,
    status: 'AUTO_RATED',
  }),
  ...
  createTrialAssessmentRecord({
    ...
    assessmentRound: 1,
    trialOrderNo: 'TR-SEW-202607-030-01',
    productionOrderNo: 'PO-SEW-202607-030',
    dispatchQty: 300,

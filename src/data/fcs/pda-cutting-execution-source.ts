  ...
  return [
    {
      ...
      calculatedLength: (preset.actualLength * preset.layerCount) + preset.headLength + preset.tailLength,
      usableLength: Math.max((preset.actualLength * preset.layerCount) + preset.headLength + preset.tailLength, 0),

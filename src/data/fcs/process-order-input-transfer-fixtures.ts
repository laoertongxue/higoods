...
export const DYE_INPUT_TRANSFER_FIXTURES: readonly ProcessOrderInputTransferFixture[] = [
  ...
  { workOrderId: 'DWO-009', productionOrderId: 'po-14671', taskId: 'TASK-DYE-000734', materialCode: 'tdv-po-14671-v1-bom-A', materialName: '面料 A · 净色 / 放行目标补料', qty: 3798, unit: '米', targetFactoryId: 'F090', targetFactoryName: '全能力测试工厂', issuedAt: '2026-06-04 09:20:00', sourceType: 'PRODUCTION_ORDER' },

...
// 结算情况列表（列表页用）- 从印尼工厂生成
export const settlementSummaries = indonesiaFactories.slice(0, 8).map((f, i) => ({
    factoryId: f.code,
    factoryName: f.name,
    cycleType: ['MONTHLY', 'BIWEEKLY', 'WEEKLY', 'PER_BATCH'][i % 4],
    pricingMode: ['BY_PIECE', 'BY_PROCESS', 'BY_ORDER'][i % 3],
    currency: 'IDR',

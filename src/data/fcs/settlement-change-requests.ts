...
const settlementEffectiveInfos: SettlementEffectiveInfo[] = [
  ...
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Surabaya Barat',
    idNumber: 'NPWP-23.716.440.2-023.000',
    bankName: 'Bank Rakyat Indonesia (BRI)',
    bankAccountNo: '4670233300882300',
    bankBranch: 'Surabaya Barat Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-周航',
    updatedBy: '平台运营-周航',
  ...
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Tangerang Selatan',
    idNumber: 'NPWP-25.339.801.5-025.000',
    bankName: 'Bank Mandiri',
    bankAccountNo: '9000255500882500',
    bankBranch: 'Tangerang Selatan Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-林静',
    updatedBy: '平台运营-林静',
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Yogya Timur',
    idNumber: 'NPWP-26.441.902.6-026.000',
    bankName: 'Bank Negara Indonesia (BNI)',
    bankAccountNo: '8800261100772600',
    bankBranch: 'Yogya Timur Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-周航',
    updatedBy: '平台运营-周航',
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Bekasi Selatan',
    idNumber: 'NPWP-27.552.013.7-027.000',
    bankName: 'Bank Central Asia (BCA)',
    bankAccountNo: '5210270088002700',
    bankBranch: 'Bekasi Selatan Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-林静',
    updatedBy: '平台运营-林静',
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Solo Utara',
    idNumber: 'NPWP-28.663.124.8-028.000',
    bankName: 'Bank Mandiri',
    bankAccountNo: '9000286600882800',
    bankBranch: 'Solo Utara Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-周航',
    updatedBy: '平台运营-周航',
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Malang Barat',
    idNumber: 'NPWP-29.774.235.9-029.000',
    bankName: 'Bank Rakyat Indonesia (BRI)',
    bankAccountNo: '4670297700882900',
    bankBranch: 'Malang Barat Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-林静',
    updatedBy: '平台运营-林静',
  },
  {
    ...
    accountHolderName: 'CV Micro Sewing Bogor Tengah',
    idNumber: 'NPWP-30.885.346.0-030.000',
    bankName: 'Bank Negara Indonesia (BNI)',
    bankAccountNo: '8800301100773000',
    bankBranch: 'Bogor Tengah Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-周航',
    updatedBy: '平台运营-周航',
  },
  {
    ...
    accountHolderName: 'kol goto',
    idNumber: 'NPWP-KOL.001.2026',
    bankName: 'Bank Central Asia (BCA)',
    bankAccountNo: '5210010088000100',
    bankBranch: 'Jakarta KOL Branch',
    versionNo: 'V1',
    effectiveAt: '2026-01-01 09:00',
    effectiveBy: '平台运营-林静',
    updatedBy: '平台运营-林静',

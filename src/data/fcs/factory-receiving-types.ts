...
export interface FactoryReceivingSourceLine {
  ...
  dyeOrderId?:string; woolOrderId?:string; productionOrderNo?:string; taskNo?:string
}
export interface FactoryReceivingSource {
  ...
  lines:FactoryReceivingSourceLine[]; workOrderNo?:string; originalRecordId?:string
}
...
export interface FactoryReceiptLineInput extends ReceiptPosition {
  ...
  weightKg?:number;grossKg?:number;tubes?:YarnTubeCounts;pcs?:number
}
...
export interface ReceivingAllocation {id:string;receiptLineId:string;dyeOrderId?:string;woolOrderId?:string;qty:number;operatorName:string;at:string}

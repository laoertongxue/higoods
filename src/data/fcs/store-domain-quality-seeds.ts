...
export const initialQualityInspections: QualityInspection[] = [
  ...
  },
  {
    ...
    refId: 'RIB-202603-0001',
    refTaskId: 'TASK-202603-0004-002',
    ...
    sourceOrderId: 'DPO-202603-2002',
    sourceReturnId: 'RIB-202603-0001',
    inspectionScene: 'RETURN_INBOUND',
    returnBatchId: 'RIB-202603-0001',
    returnProcessType: 'PRINT',
    qcPolicy: 'OPTIONAL',
    returnFactoryId: 'ID-F005',
    returnFactoryName: 'Bandung Print House',
    warehouseId: 'WH-JKT-01',
    warehouseName: '雅加达中心仓',
    sourceBusinessType: 'DYE_PRINT_ORDER',
    sourceBusinessId: 'DPO-202603-2002',
    writebackAvailableQty: 1200,
    writebackCompletedAt: '2026-03-06 16:10:00',
    writebackCompletedBy: '系统',
    downstreamUnblocked: true,
    auditLogs: [
      { id: 'AL-QC-RIB-0001-01', action: 'CREATE_FROM_RETURN_INBOUND', detail: '回货入仓批次 RIB-202603-0001 生成质检记录', at: '2026-03-06 16:08:00', by: '系统' },
      { id: 'AL-QC-RIB-0001-02', action: 'SUBMIT_QC', detail: '提交质检结果 PASS', at: '2026-03-06 16:08:00', by: '质检员A' },
    ],
    createdAt: '2026-03-06 16:08:00',
    updatedAt: '2026-03-06 16:10:00',
  },
  {
    qcId: 'QC-RIB-202603-0002',
    refType: 'TASK',
    refId: 'TASK-202603-0006-003',
    refTaskId: 'TASK-202603-0006-003',
    productionOrderId: 'PO-202603-0006',
    inspector: '质检员B',
    inspectedAt: '2026-03-08 16:10:00',
    result: 'FAIL',
    defectItems: [{ defectCode: 'RIB-D001', defectName: '缝制跳针', qty: 42 }],
    remark: '回货入仓不合格，待质量处理',
    status: 'SUBMITTED',
    ...
    responsiblePartyName: 'PT Prima Sewing Hub',
    liabilityStatus: 'DISPUTED',
    liabilityDecisionStage: 'SEW_RETURN_INBOUND_FINAL',
    liabilityDecisionRequired: true,
    deductionDecision: 'DEDUCT',
    deductionAmount: 1260,
    deductionCurrency: 'CNY',
    deductionDecisionRemark: '车缝跳针影响主批次，先按当前责任方扣款并进入争议处理',
    liabilityDecidedAt: '2026-03-08 16:11:00',
    liabilityDecidedBy: '质检主管',
    dispositionRemark: '先接受瑕疵品，后续视仲裁结果调整',
    sourceProcessType: 'SEW',
    sourceReturnId: 'RIB-202603-0004',
    inspectionScene: 'RETURN_INBOUND',
    returnBatchId: 'RIB-202603-0004',
    returnProcessType: 'SEW',
    qcPolicy: 'REQUIRED',
    returnFactoryId: 'ID-F001',
    returnFactoryName: 'PT Prima Sewing Hub',
    ...
    auditLogs: [
      { id: 'AL-QC-RIB-0002-01', action: 'CREATE_FROM_RETURN_INBOUND', detail: '回货入仓批次 RIB-202603-0004 生成质检记录', at: '2026-03-08 16:10:00', by: '系统' },
      { id: 'AL-QC-RIB-0002-02', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL', at: '2026-03-08 16:10:00', by: '质检员B' },
      { id: 'AL-QC-RIB-0002-03', action: 'FINAL_LIABILITY_DECISION', detail: '车缝回货入仓最终判定：责任方=工厂ID-F001，扣款1260 CNY，状态=争议中', at: '2026-03-08 16:11:00', by: '质检主管' },
    ],
    createdAt: '2026-03-08 16:10:00',
    updatedAt: '2026-03-08 16:10:00',
  },
  {
    qcId: 'QC-RIB-202603-0003',
    refType: 'RETURN_BATCH',
    refId: 'RIB-202603-0005',
    refTaskId: 'TASK-0009-003',
    productionOrderId: 'PO-202603-0009',
    inspector: '质检员D',
    inspectedAt: '2026-03-09 11:20:00',
    result: 'FAIL',
    defectItems: [{ defectCode: 'RIB-D002', defectName: '锁边松脱', qty: 28 }],
    remark: '车缝回货抽检不合格，已完成最终责任判定并结案',
    status: 'CLOSED',
    disposition: 'ACCEPT_AS_DEFECT',
    affectedQty: 28,
    rootCauseType: 'PROCESS',
    ...
    responsiblePartyName: 'CV Satellite Cluster',
    ...
    deductionCurrency: 'CNY',
    deductionDecisionRemark: '按车缝最终责任判定扣款，结案后可进入结算',
    ...
    inspectionScene: 'RETURN_INBOUND',
    returnBatchId: 'RIB-202603-0005',
    returnProcessType: 'SEW',
    qcPolicy: 'REQUIRED',
    returnFactoryId: 'ID-F004',
    returnFactoryName: 'CV Satellite Cluster',
    warehouseId: 'WH-BDG-01',
    warehouseName: '万隆仓库',
    sourceBusinessType: 'TASK',
    sourceBusinessId: 'TASK-0009-003',
    sewPostProcessMode: 'SEW_WITHOUT_POST_WAREHOUSE_INTEGRATED',
    writebackAvailableQty: 612,
    writebackAcceptedAsDefectQty: 28,
    writebackScrapQty: 0,
    writebackCompletedAt: '2026-03-09 11:30:00',
    writebackCompletedBy: '系统',
    downstreamUnblocked: true,
    auditLogs: [
      { id: 'AL-QC-RIB-0003-01', action: 'CREATE_FROM_RETURN_INBOUND', detail: '回货入仓批次 RIB-202603-0005 生成质检记录', at: '2026-03-09 11:20:00', by: '系统' },
      { id: 'AL-QC-RIB-0003-02', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL', at: '2026-03-09 11:20:00', by: '质检员D' },
      { id: 'AL-QC-RIB-0003-03', action: 'FINAL_LIABILITY_DECISION', detail: '车缝回货入仓最终判定：责任方=工厂ID-F004，扣款1680 CNY', at: '2026-03-09 11:22:00', by: '质检主管' },
      { id: 'AL-QC-RIB-0003-04', action: 'CLOSE_QC', detail: '结案：可用量/瑕疵量已写回，扣款依据同步完成', at: '2026-03-09 11:30:00', by: '系统' },
    ],
    createdAt: '2026-03-09 11:20:00',
    updatedAt: '2026-03-09 11:30:00',
    closedAt: '2026-03-09 11:30:00',
    closedBy: '系统',
  },
]
...
export const initialReturnInboundBatches: ReturnInboundBatch[] = [
  {
    batchId: 'RIB-202603-0001',
    productionOrderId: 'PO-202603-0004',
    sourceTaskId: 'TASK-202603-0004-002',
    processType: 'PRINT',
    processLabel: '印花',
    returnedQty: 1200,
    returnFactoryId: 'ID-F005',
    ...
    warehouseId: 'WH-JKT-01',
    warehouseName: '雅加达中心仓',
    inboundAt: '2026-03-06 16:00:00',
    inboundBy: '仓库员A',
    qcPolicy: 'OPTIONAL',
    qcStatus: 'PASS_CLOSED',
    sourceType: 'DYE_PRINT_ORDER',
    sourceId: 'DPO-202603-2002',
  ...
  },
  {
    ...
    sourceTaskId: 'TASK-202603-0005-002',
    processType: 'DYE',
    processLabel: '染色',
    returnedQty: 900,
    returnFactoryId: 'ID-F005',
    ...
    warehouseId: 'WH-JKT-01',
    warehouseName: '雅加达中心仓',
    inboundAt: '2026-03-07 10:20:00',
    inboundBy: '仓库员B',
    qcPolicy: 'OPTIONAL',
    qcStatus: 'QC_PENDING',
    sourceType: 'DYE_PRINT_ORDER',
    sourceId: 'DPO-202603-0002',
  ...
  },
  {
    ...
    warehouseName: '丹格朗仓库',
    inboundAt: '2026-03-07 09:00:00',
    inboundBy: '仓库员C',
    qcPolicy: 'OPTIONAL',
    qcStatus: 'NOT_REQUIRED',
    sourceType: 'TASK',
    sourceId: 'TASK-0002-001',
  ...
  },
  {
    ...
    productionOrderId: 'PO-202603-0006',
    sourceTaskId: 'TASK-202603-0006-003',
    processType: 'SEW',
    processLabel: '车缝',
    returnedQty: 800,
    returnFactoryId: 'ID-F001',
    ...
    qcPolicy: 'REQUIRED',
    qcStatus: 'FAIL_IN_QC',
    linkedQcId: 'QC-202603-2002',
    sourceType: 'TASK',
    sourceId: 'TASK-202603-0006-003',
    sewPostProcessMode: 'SEW_WITH_POST',
    createdAt: '2026-03-08 15:40:00',
    createdBy: '系统',
    updatedAt: '2026-03-08 16:10:00',
    updatedBy: '系统',
  },
  {
    ...
    qcPolicy: 'REQUIRED',
    qcStatus: 'QC_CLOSED',
    linkedQcId: 'QC-RIB-202603-0003',
    sourceType: 'TASK',
    sourceId: 'TASK-0009-003',
    sewPostProcessMode: 'SEW_WITHOUT_POST_WAREHOUSE_INTEGRATED',

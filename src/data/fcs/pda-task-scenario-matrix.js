...
export const PDA_MOBILE_TASK_STAGE_MINIMUMS = {
    TODO: 2,
    RECEIVE: 3,
    EXEC: 5,
    HANDOVER: 3,
};
export const PDA_MOBILE_PROCESS_DEFINITIONS = [
    {
        key: 'CUTTING',
...
export const PDA_MOBILE_FACTORY_PROFILES = [
    {
...
export function getPdaMobileProcessDefinition(key) {
    return PDA_MOBILE_PROCESS_DEFINITIONS.find((item) => item.key === key);
}
export function getPdaMobileFactoryProfile(factoryId) {

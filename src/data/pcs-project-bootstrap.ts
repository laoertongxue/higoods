...
const SCENARIO_PROJECT_SEEDS: BootstrapProjectSeed[] = [
  ...
  createScenarioProjectSeed('017', {
    ...
    linkedTechPackVersionPublishedAt: '2026-04-25 09:00',
  }),
  ...
  createScenarioProjectSeed('026', {
    projectName: '首版样衣已建任务演示款',
    projectType: '改版开发',
    projectSourceType: '历史复用',
    templateId: 'TPL-003',
    categoryId: 'seed-cat-dress',
    categoryName: '连衣裙',
    subCategoryId: 'seed-sub-dress',
    subCategoryName: '休闲连衣裙',
    brandId: 'seed-brand',
    brandName: 'Asaya',
    styleNumber: 'SPU-2026-026',
    styleType: '改版款',
    seasonTags: ['夏季'],
    styleTags: ['印花', '通勤'],
    targetAudienceTags: ['轻熟客群'],
    ...
    linkedTechPackVersionStatus: 'ACTIVE',
    linkedTechPackVersionPublishedAt: '2026-04-25 09:20',
  }),
  createScenarioProjectSeed('027', {
    projectName: '首版样衣完成展示演示款',
    projectType: '改版开发',
    projectSourceType: '历史复用',
    templateId: 'TPL-003',
    categoryId: 'seed-cat-dress',
    ...
    linkedTechPackVersionStatus: 'ACTIVE',
    linkedTechPackVersionPublishedAt: '2026-04-25 09:30',
  }),
  createScenarioProjectSeed('028', {
    projectName: '首单样衣未建任务演示款',
    projectType: '设计研发',
    projectSourceType: '历史复用',
    templateId: 'TPL-004',
    categoryId: 'seed-cat-dress',
    ...
    projectStatus: '进行中',
    currentPhaseOrder: 4,
    currentNodeCode: 'FIRST_ORDER_SAMPLE',
    currentNodeStatus: '进行中',
    latestNodeCode: 'FIRST_SAMPLE',
    latestResultType: '首版样衣打样已完成',
    latestResultText: '首版样衣已通过，等待创建首单样衣任务。',
    createdAt: '2026-04-25 10:00',
    updatedAt: '2026-04-25 10:45',
    linkedTechPackVersionId: 'TDV-ID-0006',
    linkedTechPackVersionCode: 'TDV-20260425-006',
    linkedTechPackVersionLabel: 'V1',
    linkedTechPackVersionStatus: 'ACTIVE',
    linkedTechPackVersionPublishedAt: '2026-04-25 10:00',
  }),
  createScenarioProjectSeed('029', {
    projectName: '首单样衣已建任务演示款',
    projectType: '设计研发',
    projectSourceType: '历史复用',
    templateId: 'TPL-004',
    categoryId: 'seed-cat-dress',
    ...
    currentNodeCode: 'FIRST_ORDER_SAMPLE',
    currentNodeStatus: '进行中',
    latestNodeCode: 'FIRST_ORDER_SAMPLE',
    latestResultType: '已创建首单样衣打样任务',
    latestResultText: '已创建首单样衣打样任务，待补齐详细信息。',
    createdAt: '2026-04-25 10:20',
    updatedAt: '2026-04-25 11:00',
    linkedTechPackVersionId: 'TDV-ID-0007',
    linkedTechPackVersionCode: 'TDV-20260425-007',
    linkedTechPackVersionLabel: 'V1',
    linkedTechPackVersionStatus: 'ACTIVE',
    linkedTechPackVersionPublishedAt: '2026-04-25 10:10',
  }),
  createScenarioProjectSeed('030', {
    projectName: '首单样衣完成展示演示款',
    projectType: '设计研发',
    projectSourceType: '历史复用',
    templateId: 'TPL-004',
    categoryId: 'seed-cat-dress',
    ...
    createdAt: '2026-04-25 10:40',
    updatedAt: '2026-04-25 11:20',
    linkedTechPackVersionId: 'TDV-ID-0008',
    linkedTechPackVersionCode: 'TDV-20260425-008',
    linkedTechPackVersionLabel: 'V2',
    linkedTechPackVersionStatus: 'ACTIVE',
    linkedTechPackVersionPublishedAt: '2026-04-25 10:20',
  }),
]

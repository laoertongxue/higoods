export const FLAT_DIMENSION_META = [
...
function createAuditTrail(dimensionName, itemName, seed) {
...
function buildAlias(dimensionId, value) {
    if (dimensionId === 'styleCodes') {
        return '';
    }
    return /[A-Za-z]/.test(value) ? value : '';
}
function createDimensionOptions(dimensionId, dimensionName, values) {
...
export function createInitialConfigData() {
    return {

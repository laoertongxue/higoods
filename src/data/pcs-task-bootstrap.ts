...
function createPlateSeeds(): { tasks: PlateMakingTaskRecord[]; pendingItems: PcsTaskPendingItem[] } {
  ...
  if (projectA && nodeA) {
    tasks.push({
      ...
      ...plateExecutionSeed('PT-20260109-002', {
        ...
        sampleReviewSubmittedAt: '2026-01-13 14:30:00',
        sampleReviewSubmittedBy: '王版师',
        sampleReviewerName: '当前用户',
        sampleReviewAt: '2026-01-13 16:00:00',
        sampleReviewNote: '样板比例和版型通过，待生成技术包版本。',
    ...
    tasks.push({
      plateTaskId: 'PT-20260412-REVIEW',
      plateTaskCode: 'PT-20260412-REVIEW',
      title: '制版-待样板确认演示款(P2)',
      projectId: projectA.projectId,
      projectCode: projectA.projectCode,
      projectName: projectA.projectName,
      projectNodeId: nodeA.projectNodeId,
      ...
      upstreamObjectId: 'TPL-REVIEW',
      upstreamObjectCode: 'TPL-REVIEW',
      productStyleCode: 'SPU-REVIEW-012',
      spuCode: 'SPU-REVIEW-012',
      ...plateExecutionSeed('PT-20260412-REVIEW', {
        makerName: '王版师',
        area: '印尼',
        urgent: true,
        sampleReviewStatus: '待样板确认',
        sampleReviewSubmittedAt: '2026-04-12 15:20:00',
        sampleReviewSubmittedBy: '王版师',
        materialName: '定位印雪纺面料',
        materialSku: 'FAB-REVIEW-012',
      }),
      patternType: '连衣裙',
      sizeRange: 'S-L',
      patternVersion: 'P2',
      ...
      note: '待样板确认状态演示。',
      legacyProjectRef: projectA.projectCode,
      legacyUpstreamRef: 'TPL-REVIEW',
    })
    tasks.push({
      plateTaskId: 'PT-20260414-GENERATED',
      plateTaskCode: 'PT-20260414-GENERATED',
      title: '制版-已生成技术包待完成演示款(P1)',
      projectId: projectA.projectId,
      projectCode: projectA.projectCode,
      projectName: projectA.projectName,
      projectNodeId: nodeA.projectNodeId,
      ...
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-GENERATED',
      upstreamObjectCode: 'TPL-GENERATED',
      productStyleCode: 'SPU-GENERATED-014',
      spuCode: 'SPU-GENERATED-014',
      ...plateExecutionSeed('PT-20260414-GENERATED', {
        makerName: '林版师',
        area: '深圳',
        sampleReviewStatus: '样板已通过',
        ...
        sampleReviewNote: '样板已通过，技术包草稿已生成。',
      }),
      patternType: '连体裤',
      sizeRange: 'S-L',
      patternVersion: 'P1',
      ...
      linkedTechPackVersionLabel: 'V1.0 草稿',
      linkedTechPackVersionStatus: 'DRAFT',
      linkedTechPackUpdatedAt: '2026-04-14 11:45:00',
      primaryTechPackGeneratedFlag: true,
      primaryTechPackGeneratedAt: '2026-04-14 11:45:00',
      status: '已生成技术包',
      ownerId: projectA.ownerId,
      ownerName: '林版师',
      participantNames: ['李娜'],
      ...
      note: '已生成技术包待完成状态演示。',
      legacyProjectRef: projectA.projectCode,
      legacyUpstreamRef: 'TPL-GENERATED',
    })
  }
  ...
  if (projectB && nodeB) {
    ...
    tasks.push({
      plateTaskId: 'PT-20260411-MISSING',
      plateTaskCode: 'PT-20260411-MISSING',
      title: '制版-资料缺失待补纸样演示款',
      projectId: projectB.projectId,
      projectCode: projectB.projectCode,
      projectName: projectB.projectName,
      projectNodeId: nodeB.projectNodeId,
      ...
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-MISSING',
      upstreamObjectCode: 'TPL-MISSING',
      productStyleCode: 'SPU-MISSING-011',
      spuCode: 'SPU-MISSING-011',
      ...plateExecutionSeed('PT-20260411-MISSING', {
        makerName: '李版师',
        area: '深圳',
        outputReady: false,
        materialName: '精梳棉汗布',
        materialSku: 'FAB-MISSING-011',
      }),
      patternType: '上衣',
      sizeRange: 'S-XL',
      patternVersion: '',
      ...
      participantNames: ['张工'],
      priorityLevel: '中',
      dueAt: '2026-04-12 18:00:00',
      createdAt: '2026-04-11 09:10:00',
      createdBy: '系统初始化',
      updatedAt: '2026-04-11 10:00:00',
      updatedBy: '系统初始化',
      note: '执行中缺少纸样产出状态演示。',
      legacyProjectRef: projectB.projectCode,
      legacyUpstreamRef: 'TPL-MISSING',
    })
    tasks.push({
      plateTaskId: 'PT-20260413-REJECT',
      plateTaskCode: 'PT-20260413-REJECT',
      title: '制版-样板驳回待调整演示款(P1)',
      projectId: projectB.projectId,
      projectCode: projectB.projectCode,
      projectName: projectB.projectName,
      projectNodeId: nodeB.projectNodeId,
      ...
      upstreamModule: '改版任务',
      upstreamObjectType: '改版任务',
      upstreamObjectId: 'RT-REJECT-013',
      upstreamObjectCode: 'RT-REJECT-013',
      productStyleCode: 'SPU-REJECT-013',
      spuCode: 'SPU-REJECT-013',
      ...plateExecutionSeed('PT-20260413-REJECT', {
        makerName: '李版师',
        area: '深圳',
        sampleReviewStatus: '样板已驳回',
        sampleReviewSubmittedAt: '2026-04-13 13:20:00',
        sampleReviewSubmittedBy: '李版师',
        sampleReviewerName: '当前用户',
        sampleReviewAt: '2026-04-13 15:40:00',
      ...
      participantNames: ['王工'],
      priorityLevel: '高',
      dueAt: '2026-04-14 18:00:00',
      createdAt: '2026-04-13 09:10:00',
      createdBy: '系统初始化',
      updatedAt: '2026-04-13 15:40:00',
      updatedBy: '系统初始化',
      note: '样板驳回待调整状态演示。',
      legacyProjectRef: projectB.projectCode,
      legacyUpstreamRef: 'RT-REJECT-013',
    })
  }
  ...
  ;[
    {
      ...
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-003',
      upstreamObjectCode: 'TPL-003',
      ...
      patternVersion: 'P2',
      status: '待确认' as const,
      sampleReviewStatus: '待样板确认' as const,
      sampleReviewSubmittedAt: '2026-04-02 16:10:00',
      sampleReviewSubmittedBy: '李版师',
      ownerName: '李版师',
      participantNames: ['陈工'],
      priorityLevel: '中' as const,
    ...
    },
    {
      ...
      patternVersion: 'P1',
      status: '进行中' as const,
      sampleReviewStatus: '样板已驳回' as const,
      sampleReviewSubmittedAt: '2026-04-04 15:30:00',
      sampleReviewSubmittedBy: '李版师',
      sampleReviewerName: '当前用户',
      sampleReviewAt: '2026-04-04 17:00:00',
      sampleReviewNote: '袖窿活动量不足，前胸省位需要下移 1.5cm。',
      reworkReason: '袖窿活动量不足，前胸省位需要下移 1.5cm。',
      ownerName: '李版师',
      participantNames: ['王工'],
    ...
    },
    {
      ...
      plateTaskCode: 'PT-20260425-001',
      title: '制版-首版样衣入口演示款(P1)',
      sourceType: '项目模板阶段',
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-003',
      ...
      sizeRange: 'S-XL',
      patternVersion: 'P1',
      status: '已生成技术包' as const,
      sampleReviewStatus: '样板已通过' as const,
      sampleReviewSubmittedAt: '2026-04-25 08:50:00',
      sampleReviewSubmittedBy: '王版师',
      sampleReviewerName: '当前用户',
      sampleReviewAt: '2026-04-25 09:00:00',
      sampleReviewNote: '样板结构确认通过，可进入首版样衣。',
      ownerName: '王版师',
      participantNames: ['李工'],
      priorityLevel: '高' as const,
    ...
    },
    {
      ...
      plateTaskCode: 'PT-20260425-002',
      title: '制版-首版样衣已建任务演示款(P1)',
      sourceType: '项目模板阶段',
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-003',
      upstreamObjectCode: 'TPL-003',
      productStyleCode: 'SPU-2026-026',
      spuCode: 'SPU-2026-026',
      patternType: '连衣裙',
      sizeRange: 'S-L',
      patternVersion: 'P1',
      status: '已完成' as const,
    ...
    },
    {
      ...
      plateTaskCode: 'PT-20260425-008',
      title: '制版-首版样衣完成展示演示款(P1)',
      sourceType: '项目模板阶段',
      upstreamModule: '项目模板',
      upstreamObjectType: '模板阶段',
      upstreamObjectId: 'TPL-003',
      upstreamObjectCode: 'TPL-003',
      productStyleCode: 'SPU-2026-027',
      spuCode: 'SPU-2026-027',
      patternType: '连衣裙',
      sizeRange: 'S-L',
      patternVersion: 'P1',
      status: '已完成' as const,
    ...
    const project = pickProjectByCode(item.projectCode)
    const node = project
      ? findProjectNodeByWorkItemTypeCode(project.projectId, 'PATTERN_TASK')
        ?? findProjectNodeByWorkItemTypeCode(project.projectId, 'FIRST_SAMPLE')
      : null
    if (!project || !node) return
    tasks.push({
      ...
      linkedTechPackVersionId: item.linkedTechPackVersionId,
      ...
      linkedTechPackUpdatedAt: item.linkedTechPackVersionCode ? item.updatedAt : '',
      status: item.status,
      ownerId: project.ownerId,
      ownerName: item.ownerName,
      participantNames: item.participantNames,

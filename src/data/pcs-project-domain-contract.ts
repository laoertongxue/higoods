...
export const PCS_PROJECT_TEMPLATE_SCHEMAS: PcsProjectTemplateSchema[] = [
  ...
  },
  {
    ...
    phaseSchemas: [
      ...
      { phaseCode: 'PHASE_02', whyExists: '改版出样衣需求由改版任务承接，工程开发与打样管理产出样衣后，先核对实物到样，再做初步可行性判断；判断进入测款后准备渠道店铺商品。', nodeCodes: ['REVISION_TASK', 'SAMPLE_INBOUND_CHECK', 'FEASIBILITY_REVIEW', 'CHANNEL_PRODUCT_LISTING'] },

...
export const PCS_PROJECT_WORK_ITEM_CONTRACTS: PcsProjectWorkItemContract[] = [
  {
    ...
    operationDefinitions: [
      {
        ...
        effects: ['生成项目主记录', '生成阶段记录', '生成节点记录', '进入第一阶段首个节点'],
    ...
    statusDefinitions: [
      {
        statusName: '跟随项目状态',
        entryConditions: ['商品项目创建成功后自动存在'],
        exitConditions: ['项目终止或项目归档'],
        businessMeaning: '商品项目立项节点不单独维护实例状态，直接跟随项目主状态。',
      },
    ],
    upstreamChanges: ['无上游实例，项目立项是唯一入口。'],
    downstreamChanges: ['生成项目主记录', '解锁样衣获取节点'],

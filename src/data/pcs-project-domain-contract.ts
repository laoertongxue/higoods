...
const firstOrderFields = [
  ...groupFields({
    ...
    fields: [
      { key: 'sourceFirstSampleTaskId', label: '来源首版样衣任务', type: 'text', sourceKind: '首版样衣任务', sourceRef: '首单样衣打样正式对象.sourceFirstSampleTaskId', meaning: '首单追溯的首版样衣任务', logic: '首单样衣打样默认从首版样衣带出。', readonly: true, required: false },
      ...
      { key: 'sourceFirstSampleCode', label: '来源首版结果编号', type: 'text', sourceKind: '样衣结果', sourceRef: '首单样衣打样正式对象.sourceFirstSampleCode', meaning: '来源首版结果编号', logic: '页面展示和归档使用。', required: false },
      { key: 'sourceTechPackVersionId', label: '来源技术包版本ID', type: 'text', sourceKind: '技术包版本', sourceRef: '首单样衣打样正式对象.sourceTechPackVersionId', meaning: '首单引用的技术包版本 ID', logic: '由技术包链路或人工选择回写。', required: false },
      { key: 'sourceTechPackVersionCode', label: '来源技术包版本编码', type: 'text', sourceKind: '技术包版本', sourceRef: '首单样衣打样正式对象.sourceTechPackVersionCode', meaning: '首单引用的技术包版本编码', logic: '用于生产参照。', required: false },
      { key: 'sourceTechPackVersionLabel', label: '来源技术包版本标签', type: 'text', sourceKind: '技术包版本', sourceRef: '首单样衣打样正式对象.sourceTechPackVersionLabel', meaning: '首单引用的技术包版本标签', logic: '用于页面展示。', required: false },

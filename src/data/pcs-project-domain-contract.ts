...
const styleArchiveFields = [
  ...groupFields({
    ...
    fields: [
      ...
      { key: 'linkedPatternAssetIds', label: '关联花型库资产', type: 'reference-multi', sourceKind: '花型库', sourceRef: '技术包版本.linkedPatternAssetIds', meaning: '当前技术包引用的花型库资产', logic: '由花型任务写入技术包或花型库沉淀链路回写。', readonly: true, required: false },
...
const artworkTaskFields = [
  ...
  ...groupFields({
    ...
    fields: [
      ...
      { key: 'sourceTechPackVersionId', label: '来源技术包版本', type: 'text', sourceKind: '花型库', sourceRef: '花型库资产.source_tech_pack_version_id', meaning: '花型库资产已写入的技术包版本', logic: '花型写入技术包后由花型库资产来源链记录。', readonly: true, required: false },
      { key: 'projectArchiveStatus', label: '归档状态摘要', type: 'text', sourceKind: '项目资料归档', sourceRef: '项目资料归档正式对象', meaning: '花型库资产和花型任务是否已被项目资料归档采集', logic: '由项目资料归档同步器按花型任务和花型库资产采集结果汇总。', readonly: true, required: false },
    ],
  }),
  ...groupFields({
...
const firstSampleFields = [
  ...groupFields({
    ...
    title: '来源与基础信息',
    description: '首版样衣的来源任务、来源技术包、打样工厂和物流信息。',
    fields: [
  ...
  ...groupFields({
    id: 'first-sample-asset',
    title: '样衣信息',
    description: '首版样衣的材质模式、样衣用途、样衣资产和图片。',
    fields: [
      ...
      { key: 'samplePurpose', label: '样衣用途', type: 'single-select', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.samplePurpose', meaning: '首版确认或产前复用候选', logic: '首版确认通过后可作为产前复用候选。' },
      ...
      { key: 'sampleAssetIds', label: '样衣资产', type: 'text', sourceKind: '样衣资产', sourceRef: '首版样衣正式对象.sampleAssetIds', meaning: '首版样衣关联的样衣资产集合', logic: '默认一件，也支持多资产引用。', readonly: true, required: false },
      { key: 'sampleImageIds', label: '样衣图片', type: 'image-list', sourceKind: '样衣资产', sourceRef: '首版样衣正式对象.sampleImageIds', meaning: '首版样衣图片', logic: '样衣图片进入项目资料归档。', required: false },
    ],
  }),
  ...groupFields({
    id: 'first-sample-confirmation',
    title: '确认结论',
    description: '首版样衣确认结果和是否可复用为产前版参照。',
    fields: [
      ...
      { key: 'productionReadinessNote', label: '生产准备说明', type: 'textarea', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.productionReadinessNote', meaning: '是否可进入产前参照准备', logic: '不改变项目决策规则，只记录样衣内部结论。', required: false },
      { key: 'reuseAsPreProductionFlag', label: '是否可复用为产前版', type: 'boolean', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.reuseAsPreProductionFlag', meaning: '首版样衣是否可直接作为产前参照', logic: '大多数情况下确认通过后可置为是。', required: false },
      { key: 'reuseAsPreProductionConfirmedAt', label: '复用确认时间', type: 'datetime', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.reuseAsPreProductionConfirmedAt', meaning: '确认首版样衣可复用为产前版的时间', logic: '由确认动作或人工维护回写。', required: false },
      { key: 'reuseAsPreProductionConfirmedBy', label: '复用确认人', type: 'text', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.reuseAsPreProductionConfirmedBy', meaning: '确认复用的人', logic: '由确认动作或人工维护回写。', required: false },
      { key: 'reuseAsPreProductionNote', label: '复用说明', type: 'textarea', sourceKind: '首版样衣任务', sourceRef: '首版样衣正式对象.reuseAsPreProductionNote', meaning: '复用为产前参照的补充说明', logic: '用于记录复用限制和注意事项。', required: false },
      { key: 'projectArchiveStatus', label: '归档状态摘要', type: 'text', sourceKind: '项目资料归档', sourceRef: '项目资料归档正式对象', meaning: '首版样衣任务、样衣图片和样衣资产是否已被归档采集', logic: '由项目资料归档同步器按样衣链路采集结果汇总。', readonly: true, required: false },
...
const preProductionFields = [
  ...groupFields({
    id: 'pre-production-source',
    title: '首版来源',
    description: '产前版样衣追溯的首版样衣任务和首版样衣资产。',
    fields: [
      { key: 'sourceFirstSampleTaskId', label: '来源首版样衣任务', type: 'text', sourceKind: '首版样衣任务', sourceRef: '产前版样衣正式对象.sourceFirstSampleTaskId', meaning: '产前版追溯的首版样衣任务', logic: '产前版样衣默认从首版样衣带出。', readonly: true, required: false },
      { key: 'sourceFirstSampleTaskCode', label: '来源首版样衣任务编码', type: 'text', sourceKind: '首版样衣任务', sourceRef: '产前版样衣正式对象.sourceFirstSampleTaskCode', meaning: '来源首版样衣任务编码', logic: '用于项目链路展示。', readonly: true, required: false },
      { key: 'sourceFirstSampleAssetId', label: '来源首版样衣资产', type: 'text', sourceKind: '样衣资产', sourceRef: '产前版样衣正式对象.sourceFirstSampleAssetId', meaning: '可复用的首版样衣资产', logic: '直接复用首版样衣时必填。', required: false },
      { key: 'sourceFirstSampleCode', label: '来源首版样衣编号', type: 'text', sourceKind: '样衣资产', sourceRef: '产前版样衣正式对象.sourceFirstSampleCode', meaning: '来源首版样衣编号', logic: '页面展示和归档使用。', required: false },
      { key: 'sourceTechPackVersionId', label: '来源技术包版本ID', type: 'text', sourceKind: '技术包版本', sourceRef: '产前版样衣正式对象.sourceTechPackVersionId', meaning: '产前版引用的技术包版本 ID', logic: '由技术包链路或人工选择回写。', required: false },
      { key: 'sourceTechPackVersionCode', label: '来源技术包版本编码', type: 'text', sourceKind: '技术包版本', sourceRef: '产前版样衣正式对象.sourceTechPackVersionCode', meaning: '产前版引用的技术包版本编码', logic: '用于生产参照。', required: false },
      { key: 'sourceTechPackVersionLabel', label: '来源技术包版本标签', type: 'text', sourceKind: '技术包版本', sourceRef: '产前版样衣正式对象.sourceTechPackVersionLabel', meaning: '产前版引用的技术包版本标签', logic: '用于页面展示。', required: false },
  ...
  ...groupFields({
    id: 'pre-production-chain',
    title: '链路模式',
    description: '产前版支持直接复用首版样衣、新增一件产前版样衣或双样衣。',
    fields: [
      { key: 'sampleChainMode', label: '样衣链路模式', type: 'single-select', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.sampleChainMode', meaning: '产前版样衣链路模式', logic: '选项为直接复用首版样衣、新增一件产前版样衣、双样衣。' },
      { key: 'specialSceneReasonCodes', label: '特殊场景原因', type: 'multi-select', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.specialSceneReasonCodes', meaning: '新增产前样或双样衣的原因', logic: '选项固定为定位印、大货量大、工厂参照样、正确布确认、其它。', required: false },
      { key: 'specialSceneReasonText', label: '特殊场景说明', type: 'textarea', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.specialSceneReasonText', meaning: '特殊场景补充说明', logic: '不得替代正式原因字段。', required: false },
      { key: 'productionReferenceRequiredFlag', label: '是否需要生产参照', type: 'boolean', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.productionReferenceRequiredFlag', meaning: '是否需要给工厂提供参照样', logic: '为是时必须有工厂参照样计划。', required: false },
      { key: 'chinaReviewRequiredFlag', label: '是否需要中国确认', type: 'boolean', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.chinaReviewRequiredFlag', meaning: '是否需要中国团队确认', logic: '定位印或大货量大场景可记录。', required: false },
      { key: 'correctFabricRequiredFlag', label: '是否需要正确布确认', type: 'boolean', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.correctFabricRequiredFlag', meaning: '是否需要正确布样衣', logic: '双样衣场景通常为是。', required: false },
    ],
  }),
  ...groupFields({
    id: 'pre-production-plan',
    title: '样衣计划',
    description: '记录复用首版样衣、替代布确认样、正确布确认样和工厂参照样。',
    fields: [
      { key: 'samplePlanLines', label: '样衣计划行', type: 'table', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.samplePlanLines', meaning: '产前版样衣计划明细', logic: '计划行承接样衣角色、材质模式、数量、工厂和样衣资产。' },
      ...
      { key: 'materialMode', label: '材质模式', type: 'single-select', sourceKind: '样衣计划行', sourceRef: 'SamplePlanLine.materialMode', meaning: '复用首版、替代布或正确布', logic: '双样衣必须区分替代布和正确布。' },
      ...
      { key: 'linkedSampleAssetId', label: '对应样衣资产', type: 'text', sourceKind: '样衣资产', sourceRef: 'SamplePlanLine.linkedSampleAssetId', meaning: '计划行对应的样衣资产', logic: '复用首版时可引用同一件样衣资产。', required: false },
    ],
  }),
  ...groupFields({
    id: 'pre-production-final-reference',
    title: '最终参照',
    description: '产前版最终作为生产参照的样衣资产。',
    fields: [
      { key: 'finalReferenceSampleAssetIds', label: '最终参照样衣', type: 'text', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.finalReferenceSampleAssetIds', meaning: '最终用于生产参照的样衣资产集合', logic: '直接复用首版时包含首版样衣资产。' },
      { key: 'finalReferenceNote', label: '说明', type: 'textarea', sourceKind: '产前版样衣任务', sourceRef: '产前版样衣正式对象.finalReferenceNote', meaning: '最终参照样衣说明', logic: '记录参照限制和补充说明。', required: false },
      { key: 'projectArchiveStatus', label: '归档状态摘要', type: 'text', sourceKind: '项目资料归档', sourceRef: '项目资料归档正式对象', meaning: '产前版样衣任务、样衣计划和最终参照样衣是否已被归档采集', logic: '由项目资料归档同步器按样衣链路采集结果汇总。', readonly: true, required: false },

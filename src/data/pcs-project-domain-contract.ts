...
const videoTestFields = [
  ...groupFields({
    id: 'video-test-main',
    title: '短视频测款',
    description: '短视频测款必须引用已上架待测款的渠道店铺商品。',
    fields: [
      { key: 'channelProductId', label: '渠道店铺商品', type: 'reference', sourceKind: '项目来源', sourceRef: '商品上架实例', meaning: '引用的渠道店铺商品实例', logic: '必须来自已上架待测款渠道店铺商品。', placeholder: '请选择渠道店铺商品' },
      { key: 'channelProductCode', label: '渠道店铺商品编码', type: 'text', sourceKind: '项目来源', sourceRef: '商品上架实例', meaning: '内部渠道店铺商品编码', logic: '由商品上架实例回带。', readonly: true },
      ...
      { key: 'videoChannel', label: '发布渠道', type: 'single-select', sourceKind: '短视频测款', sourceRef: '短视频测款正式记录.channelName', meaning: '短视频发布渠道', logic: '发布渠道直接来自正式短视频测款记录，不额外伪装成配置工作台字段。' },
      { key: 'exposureQty', label: '曝光量', type: 'number', sourceKind: '短视频测款', sourceRef: '短视频测款记录', meaning: '短视频曝光量', logic: '来源短视频测款正式记录。' },
      { key: 'clickQty', label: '点击量', type: 'number', sourceKind: '短视频测款', sourceRef: '短视频测款记录', meaning: '短视频点击量', logic: '来源短视频测款正式记录。' },
      { key: 'orderQty', label: '下单量', type: 'number', sourceKind: '短视频测款', sourceRef: '短视频测款记录', meaning: '短视频下单量', logic: '来源短视频测款正式记录。' },
      { key: 'gmvAmount', label: '销售额', type: 'number', sourceKind: '短视频测款', sourceRef: '短视频测款记录', meaning: '短视频销售额', logic: '来源短视频测款正式记录。' },
...
const liveTestFields = [
  ...groupFields({
    id: 'live-test-main',
    title: '直播测款',
    description: '直播测款必须引用已上架待测款的渠道店铺商品和直播挂车明细。',
    fields: [
      { key: 'channelProductId', label: '渠道店铺商品', type: 'reference', sourceKind: '项目来源', sourceRef: '商品上架实例', meaning: '引用的渠道店铺商品实例', logic: '必须来自已上架待测款渠道店铺商品。', placeholder: '请选择渠道店铺商品' },
      { key: 'channelProductCode', label: '渠道店铺商品编码', type: 'text', sourceKind: '项目来源', sourceRef: '商品上架实例', meaning: '内部渠道店铺商品编码', logic: '由商品上架实例回带。', readonly: true },
      { key: 'upstreamChannelProductCode', label: '上游渠道商品编码', type: 'text', sourceKind: '项目来源', sourceRef: '商品上架实例', meaning: '上游渠道商品编码', logic: '由商品上架实例回带。', readonly: true },
      { key: 'liveSessionId', label: '直播测款', type: 'reference', sourceKind: '直播测款', sourceRef: '直播测款', meaning: '直播测款主记录', logic: '直播测款必须引用正式直播测款。', placeholder: '请选择直播测款' },
      { key: 'liveLineId', label: '直播挂车明细', type: 'reference', sourceKind: '直播测款', sourceRef: '直播挂车明细', meaning: '直播挂车商品明细', logic: '必须引用正式直播挂车明细。', placeholder: '请选择直播挂车明细' },
      { key: 'exposureQty', label: '曝光量', type: 'number', sourceKind: '直播测款', sourceRef: '直播挂车明细', meaning: '直播曝光量', logic: '来源直播挂车明细。' },
      { key: 'clickQty', label: '点击量', type: 'number', sourceKind: '直播测款', sourceRef: '直播挂车明细', meaning: '直播点击量', logic: '来源直播挂车明细。' },
      { key: 'orderQty', label: '下单量', type: 'number', sourceKind: '直播测款', sourceRef: '直播挂车明细', meaning: '直播下单量', logic: '来源直播挂车明细。' },
      { key: 'gmvAmount', label: '销售额', type: 'number', sourceKind: '直播测款', sourceRef: '直播挂车明细', meaning: '直播销售额', logic: '来源直播挂车明细。' },
...
export const PCS_PROJECT_WORK_ITEM_CONTRACTS: PcsProjectWorkItemContract[] = [
  ...
  },
  {
    ...
    scenario: '短视频测款只允许引用已上架待测款的渠道店铺商品。',
    keepReason: '短视频测款必须与商品上架形成事实链，不能脱离渠道店铺商品存在。',
    roleNames: ['内容运营', '渠道运营'],
    ...
    operationDefinitions: [
      {
        ...
        preconditions: ['必须存在已上架待测款的渠道店铺商品'],
    ...
    upstreamChanges: ['引用商品上架实例和短视频测款记录。'],
    downstreamChanges: ['为测款数据汇总提供短视频事实'],
    businessRules: ['不能跳过商品上架直接测款', '一条短视频测款只允许绑定一个商品项目'],
    systemConstraints: ['channelProductStatus 必须为已上架待测款', '同一条短视频测款记录只允许回写一个商品项目'],
  },
  {
    workItemId: 'WI-011',
    ...
    scenario: '直播测款只允许引用已上架待测款的渠道店铺商品和直播挂车明细。',
    ...
    businessRules: ['不能跳过商品上架直接测款', '一条直播测款只允许绑定一个商品项目'],
  ...
  },
  {
    ...
    instanceStatusDefinitions: [
      ...
      { statusName: '进行中', entryConditions: ['任务开始执行'], exitConditions: ['提交评审、异常待处理或取消'], businessMeaning: '改版任务进行中。' },
      { statusName: '待评审', entryConditions: ['改版任务提交评审'], exitConditions: ['确认、回退或取消'], businessMeaning: '等待改版评审。' },

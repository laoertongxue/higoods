...
const artworkTaskFields = [
  ...groupFields({
    ...
    fields: [
      ...
      { key: 'processType', label: '工艺', type: 'single-select', sourceKind: '本地主数据', sourceRef: '花型任务表单', meaning: '花型工艺分类', logic: '固定为数码印、烫画或直喷。' },
      ...
      { key: 'fabricName', label: '面料名称', type: 'text', sourceKind: '花型任务', sourceRef: '花型任务正式对象.fabricName', meaning: '买手确认的面料名称', logic: '面料编码或面料名称至少填写一项。', required: false },
  ...
  ...groupFields({
    ...
    fields: [
      { key: 'assignedTeamCode', label: '团队', type: 'single-select', sourceKind: '本地主数据', sourceRef: '花型任务团队配置', meaning: '执行团队', logic: '只能选择中国团队、万隆团队或雅加达团队。' },
      { key: 'assignedMemberId', label: '花型师', type: 'single-select', sourceKind: '本地主数据', sourceRef: '花型任务团队配置', meaning: '执行花型师', logic: '成员选项受团队约束。' },

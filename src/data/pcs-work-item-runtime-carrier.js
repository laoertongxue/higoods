const PCS_WORK_ITEM_RUNTIME_CARRIERS = {
    PROJECT_INIT: {
...
export function getPcsWorkItemRuntimeCarrierDefinition(workItemTypeCode) {
    return { ...PCS_WORK_ITEM_RUNTIME_CARRIERS[workItemTypeCode] };
}
export function listPcsWorkItemRuntimeCarrierDefinitions() {

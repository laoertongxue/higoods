...
export function createTechnicalDataVersionBootstrapSnapshot(
  ...
  if (project018Style) {
    ...
    records.push({
      ...
      sourceProjectId: project018Style.sourceProjectId || 'PRJ-026',
      sourceProjectCode: project018Style.sourceProjectCode || 'PRJ-202604-014',
      sourceProjectName: project018Style.sourceProjectName || '修身弹力牛仔裤',
    ...
    records.push({
      ...
      createdFromTaskId: 'PT-20260611-018-V2',
      createdFromTaskCode: 'PT-20260611-018-V2',
      baseTechnicalVersionId: technicalVersionId,
      baseTechnicalVersionCode: baseRecord.technicalVersionCode,
      changeScope: '改版生成',
      changeSummary: '演示新增技术包版本：买手和版师范围沿用 V1.0，仅工序工艺有变化，提交审核时买手/版师应标记无需审核。',
      versionStatus: 'DRAFT',
      reviewStage: '未提交审核',

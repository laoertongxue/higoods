...
const FALLBACK_PROJECTS: PcsProjectListRecord[] = [
  { projectId: 'prj_20251216_015', projectCode: 'PRJ-20251216-015', projectName: '设计款中式盘扣上衣', styleType: '设计款', categoryName: '上衣', subCategoryName: '上衣', styleTagNames: ['中式', '优雅'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '进行中', currentPhaseName: '款式档案与开发推进', ownerName: '李娜', updatedAt: '2026-04-06 14:40', progressDone: 13, progressTotal: 21, nextWorkItemName: '项目转档准备', nextWorkItemStatus: '进行中', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_025', projectCode: 'PRJ-20251216-025', projectName: '改版针织背心淘汰', styleType: '改版款', categoryName: '马甲', subCategoryName: '马甲', styleTagNames: ['通勤', '复古'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '已终止', currentPhaseName: '商品上架与市场测款', ownerName: '赵云', updatedAt: '2026-04-06 09:50', progressDone: 9, progressTotal: 15, nextWorkItemName: '-', nextWorkItemStatus: '-', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_024', projectCode: 'PRJ-20251216-024', projectName: '快反居家套装淘汰', styleType: '快时尚款', categoryName: '套装', subCategoryName: '居家套装', styleTagNames: ['休闲', '甜美'], targetChannelCodes: ['wechat-mini-program', 'tiktok-shop'], projectStatus: '已终止', currentPhaseName: '商品上架与市场测款', ownerName: '王明', updatedAt: '2026-04-05 16:20', progressDone: 9, progressTotal: 15, nextWorkItemName: '-', nextWorkItemStatus: '-', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_023', projectCode: 'PRJ-20251216-023', projectName: '基础款男装休闲夹克淘汰', styleType: '基础款', categoryName: '外套', subCategoryName: '夹克', styleTagNames: ['休闲', '街头'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '已终止', currentPhaseName: '商品上架与市场测款', ownerName: '张丽', updatedAt: '2026-04-05 11:10', progressDone: 12, progressTotal: 20, nextWorkItemName: '-', nextWorkItemStatus: '-', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_014', projectCode: 'PRJ-20251216-014', projectName: '快反商务修身长袖衬衫', styleType: '快时尚款', categoryName: '上衣', subCategoryName: '衬衫', styleTagNames: ['通勤', '优雅'], targetChannelCodes: ['tiktok-shop', 'wechat-mini-program'], projectStatus: '进行中', currentPhaseName: '款式档案与开发推进', ownerName: '王明', updatedAt: '2026-04-05 10:50', progressDone: 11, progressTotal: 15, nextWorkItemName: '项目转档准备', nextWorkItemStatus: '进行中', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_013', projectCode: 'PRJ-20251216-013', projectName: '设计款户外轻量夹克', styleType: '设计款', categoryName: '外套', subCategoryName: '夹克', styleTagNames: ['秀场', '优雅'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '进行中', currentPhaseName: '款式档案与开发推进', ownerName: '李娜', updatedAt: '2026-04-04 16:10', progressDone: 13, progressTotal: 21, nextWorkItemName: '项目转档准备', nextWorkItemStatus: '进行中', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_022', projectCode: 'PRJ-20251216-022', projectName: '设计款民族印花半裙暂缓', styleType: '设计款', categoryName: '半裙', subCategoryName: '半裙', styleTagNames: ['碎花', '秀场'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '进行中', currentPhaseName: '商品上架与市场测款', ownerName: '李娜', updatedAt: '2026-04-04 15:30', progressDone: 11, progressTotal: 21, nextWorkItemName: '测款结论判定', nextWorkItemStatus: '待确认', pendingDecisionFlag: true, riskStatus: '正常', riskReason: '测款结论为暂缓，等待重新评估花型方向。' },
  { projectId: 'prj_20251216_021', projectCode: 'PRJ-20251216-021', projectName: '改版都市西装马甲暂缓', styleType: '改版款', categoryName: '马甲', subCategoryName: '马甲', styleTagNames: ['通勤', '复古'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '进行中', currentPhaseName: '商品上架与市场测款', ownerName: '赵云', updatedAt: '2026-04-04 09:40', progressDone: 9, progressTotal: 15, nextWorkItemName: '测款结论判定', nextWorkItemStatus: '待确认', pendingDecisionFlag: true, riskStatus: '正常', riskReason: '当前测款窗口结束，项目暂缓，等待复盘结论。' },
  { projectId: 'prj_20251216_011', projectCode: 'PRJ-20251216-011', projectName: '基础轻甜印花连衣裙', styleType: '基础款', categoryName: '连衣裙', subCategoryName: '连衣裙', styleTagNames: ['休闲', '甜美'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '进行中', currentPhaseName: '款式档案与开发推进', ownerName: '张丽', updatedAt: '2026-04-03 15:20', progressDone: 14, progressTotal: 20, nextWorkItemName: '项目转档准备', nextWorkItemStatus: '进行中', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_020', projectCode: 'PRJ-20251216-020', projectName: '快反POLO衫暂缓', styleType: '快时尚款', categoryName: '上衣', subCategoryName: 'POLO衫', styleTagNames: ['休闲', '通勤'], targetChannelCodes: ['tiktok-shop', 'wechat-mini-program'], projectStatus: '进行中', currentPhaseName: '商品上架与市场测款', ownerName: '王明', updatedAt: '2026-04-03 13:10', progressDone: 9, progressTotal: 15, nextWorkItemName: '测款结论判定', nextWorkItemStatus: '待确认', pendingDecisionFlag: true, riskStatus: '正常', riskReason: '当前结论为暂缓，等待补齐货盘与流量方案后再重启。' },
  { projectId: 'prj_20251216_012', projectCode: 'PRJ-20251216-012', projectName: '快反撞色卫衣套装', styleType: '快时尚款', categoryName: '套装', subCategoryName: '卫衣套装', styleTagNames: ['休闲', '通勤'], targetChannelCodes: ['tiktok-shop', 'wechat-mini-program'], projectStatus: '进行中', currentPhaseName: '款式档案与开发推进', ownerName: '王明', updatedAt: '2026-04-02 11:00', progressDone: 11, progressTotal: 15, nextWorkItemName: '项目转档准备', nextWorkItemStatus: '进行中', pendingDecisionFlag: false, riskStatus: '正常', riskReason: '' },
  { projectId: 'prj_20251216_019', projectCode: 'PRJ-20251216-019', projectName: '基础款针织开衫暂缓', styleType: '基础款', categoryName: '开衫', subCategoryName: '开衫', styleTagNames: ['休闲', '通勤'], targetChannelCodes: ['wechat-mini-program', 'tiktok-shop'], projectStatus: '进行中', currentPhaseName: '商品上架与市场测款', ownerName: '张丽', updatedAt: '2026-04-02 10:30', progressDone: 12, progressTotal: 20, nextWorkItemName: '测款结论判定', nextWorkItemStatus: '待确认', pendingDecisionFlag: true, riskStatus: '正常', riskReason: '测款结论为暂缓，当前项目阻塞，等待下轮市场窗口。' },
  ...
  { projectId: 'prj_20251216_004', projectCode: 'PRJ-20251216-004', projectName: '复古皮质机车夹克', styleType: '改版款', categoryName: '外套', subCategoryName: '夹克', styleTagNames: ['复古', '街头'], targetChannelCodes: ['tiktok-shop', 'shopee'], projectStatus: '已立项', currentPhaseName: '样衣与评估', ownerName: '赵云', updatedAt: '2025-12-15 16:20', progressDone: 3, progressTotal: 15, nextWorkItemName: '初步可行性判断', nextWorkItemStatus: '待确认', pendingDecisionFlag: true, riskStatus: '正常', riskReason: '' },

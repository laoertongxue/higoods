      ...
      items: [
        {
          ...
          icon: 'PackageCheck',
          children: [
            { key: 'pfos-post-finishing-wait-process-warehouse', title: '回货确认与送检', icon: 'Warehouse', href: '/fcs/craft/post-finishing/wait-process-warehouse' },
            { key: 'pfos-post-finishing-qc-workbench', title: 'Web 质检工作台', icon: 'ScanLine', href: '/fcs/craft/post-finishing/qc-workbench' },
            { key: 'pfos-post-finishing-qc-orders', title: '质检任务管理', icon: 'ClipboardCheck', href: '/fcs/craft/post-finishing/qc-orders' },
            { key: 'pfos-post-finishing-work-orders', title: '后道加工任务', icon: 'ClipboardList', href: '/fcs/craft/post-finishing/work-orders' },

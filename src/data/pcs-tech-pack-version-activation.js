...
export function activateTechPackVersionForStyle(styleId, technicalVersionId, operatorName = '当前用户') {
    ...
    if (record.sourceProjectId) {
        ...
        if (sourceNode.projectNodeId) {
            updateProjectNodeRecord(record.sourceProjectId, sourceNode.projectNodeId, {
                currentStatus: '进行中',

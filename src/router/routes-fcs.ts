...
import {
  ...
  renderSewingProductionOrderDurationPage,
  ...
  renderWaterSolublePendingHandoverPage,
  renderWaterSolubleHandoverDocumentsPage,
...
export const routes: RouteRegistry = {
  exactRoutes: {
    ...
    '/fcs/dispatch/workbench': () => renderUnifiedDispatchWorkbenchPage(),
    ...
    '/fcs/dispatch/board': () => renderRouteRedirect('/fcs/dispatch/workbench?type=NON_SEWING', '正在跳转到任务分配工作台'),
    '/fcs/dispatch/non-sewing': () => renderRouteRedirect('/fcs/dispatch/workbench?type=NON_SEWING', '正在跳转到任务分配工作台'),
    '/fcs/dispatch/sewing': () => renderRouteRedirect('/fcs/dispatch/workbench?type=SEWING', '正在跳转到任务分配工作台'),
    '/fcs/dispatch/acceptance-sla': () => renderDispatchAcceptanceSlaPage(),
    '/fcs/dispatch/tenders': () => renderDispatchTendersPage(),
    '/fcs/contracts': () => renderProductionContractCenterPage(),
    '/fcs/contracts/print': () => renderProductionContractPrintPage(),
    ...
    '/fcs/production_order_track/index': () => renderProductionOrderProgressTrackingPage(),
    ...
    '/fcs/craft/cutting/replacement-fabric-fei-tickets': () => renderReplacementFabricFeiTicketsPage(),
    ...
    '/fcs/craft/cutting/cut-piece-return-processing': () => renderCraftCuttingCutPieceReturnProcessingPage(),
    ...
    '/fcs/craft/dyeing/pending-handover': () => renderCraftDyeingPendingHandoverPage(),
    '/fcs/craft/dyeing/handover-documents': () => renderCraftDyeingHandoverDocumentsPage(),
    ...
    '/fcs/craft/post-finishing/print': () => renderPostFinishingFullFlowPrintPage(),
    '/fcs/craft/post-finishing/audit-records': () => renderPostFinishingAuditRecordsPage(),

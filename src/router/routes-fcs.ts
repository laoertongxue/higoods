...
export const routes: RouteRegistry = {
  exactRoutes: {
    ...
    '/fcs/craft/cutting/pickup-management': () =>
      renderRouteRedirect('/fcs/craft/cutting/pickup-ready', '正在跳转到已配待领'),
    '/fcs/craft/cutting/pickup-ready': () => renderCraftCuttingPickupReadyPage(),
    '/fcs/craft/cutting/pickup-incomplete': () => renderCraftCuttingPickupIncompletePage(),
    '/fcs/craft/cutting/pickup-history': () => renderCraftCuttingPickupHistoryPage(),

...
export const routes: RouteRegistry = {
  exactRoutes: {
    ...
    '/fcs/pda/post-finishing/return-confirm': () => renderPdaPostFinishingReturnConfirmationPage(),
    ...
    '/fcs/pda/cutting/transfer-bag/repack': () => renderPdaCuttingTransferBagRepackPage(),
    '/fcs/pda/cutting/transfer-bag/recovery': () => renderPdaCuttingTransferBagRecoveryPage(),
    '/fcs/pda/cutting/transfer-bag/scrap': () => renderPdaCuttingTransferBagScrapPage(),

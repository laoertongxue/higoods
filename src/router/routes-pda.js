import { renderPdaLoginPage, renderPdaOnboardingPage, renderPdaNotifyDetailPage, renderPdaNotifyDueSoonPage, renderPdaNotifyPage, renderPdaQualityDetailPage, renderPdaQualityPage, renderPdaSettlementPage, renderPdaTaskReceiveDetailPage, renderPdaTaskReceivePage, renderPdaExecDetailPage, renderPdaExecPage, renderPdaHandoverDetailPage, renderPdaHandoverPage, renderPdaTransferBagDetailPage, renderPdaCuttingExecutionUnitPage, renderPdaCuttingHandoverPage, renderPdaCuttingInboundPage, renderPdaCuttingReplenishmentFeedbackPage, renderPdaCuttingSpreadingPage, renderPdaCuttingTaskDetailPage, renderPdaWarehousePage, renderPdaWarehouseWaitProcessPage, renderPdaWarehouseWaitHandoverPage, renderPdaWarehouseInboundRecordsPage, renderPdaWarehouseOutboundRecordsPage, renderPdaWarehouseStocktakePage, } from './route-renderers';
...
export const routes = {
    exactRoutes: {
        '/fcs/pda': () => renderRouteRedirect(resolvePdaPostLoginRoute(getPdaCurrentAuthSession(), '/fcs/pda/exec') || buildPdaAuthLoginPath('/fcs/pda/exec'), '工厂端移动应用'),

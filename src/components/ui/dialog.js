 ...
 */
export function renderDialog(config, content, footer) {
 ...
 * 渲染确认对话框
 */
export function renderConfirmDialog(config, content) {
 ...
 * 渲染警告/信息对话框
 */
export function renderAlertDialog(config, content) {
 ...
 * 渲染带表单的对话框
 */
export function renderFormDialog(config, formContent) {

...
const PCS_HANDLER_SPECS: PcsHandlerSpec[] = [
  ...
  },
  {
    ...
    matches: (pathname) => isExactOrNestedPath(pathname, '/pcs/technical-data'),
    importModule: () => import('../pages/pcs-technical-data'),
    eventExport: 'handlePcsTechnicalDataEvent',
    inputExport: 'handlePcsTechnicalDataInput',
    dialogExport: 'isPcsTechnicalDataDialogOpen',

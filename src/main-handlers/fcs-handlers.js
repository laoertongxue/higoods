import { handleFactoryPageEvent, handleFactoryPageSubmit, isFactoryPageOpenDialog, } from '../pages/factory-profile';
import { handleFactoryOnboardingEvent, isFactoryOnboardingDialogOpen, } from '../pages/factory-onboarding';
import { handleFactoryCapacityProfileEvent, isFactoryCapacityProfileDialogOpen, } from '../pages/factory-capacity-profile';
import { handleFactoryInternalWarehouseEvent, isFactoryInternalWarehouseDialogOpen, } from '../pages/factory-internal-warehouse';
import { handleCapabilityEvent, handleCapabilitySubmit, isCapabilityDialogOpen, } from '../pages/capability';
import { handleFactoryStatusEvent, isFactoryStatusDialogOpen, } from '../pages/factory-status';
import { handleFactoryPerformanceEvent, isFactoryPerformanceDialogOpen, } from '../pages/factory-performance';
import { handleSettlementEvent, handleSettlementSubmit, isSettlementDialogOpen, } from '../pages/settlement';
import { handleCapacityEvent } from '../pages/capacity';
import { handleProductionEvent, handleProductionSubmit, isProductionDialogOpen, } from '../pages/production';
import { closeProductionCraftDictDialog, handleProductionCraftDictEvent, isProductionCraftDictDialogOpen, } from '../pages/production-craft-dict';
import { handleTechPackEvent, isTechPackDialogOpen } from '../pages/tech-pack';
import { handleProcessDyeRequirementsEvent, isProcessDyeRequirementsDialogOpen, } from '../pages/process-dye-requirements';
import { handleProcessPrintRequirementsEvent, isProcessPrintRequirementsDialogOpen, } from '../pages/process-print-requirements';
import { handleProcessDyeOrdersEvent, isProcessDyeOrdersDialogOpen, } from '../pages/process-dye-orders';
import { handleProcessPrintOrdersEvent, isProcessPrintOrdersDialogOpen, } from '../pages/process-print-orders';
import { handleTaskBreakdownEvent, isTaskBreakdownDialogOpen, } from '../pages/task-breakdown';
import { handleDyePrintOrdersEvent, isDyePrintOrdersDialogOpen, } from '../pages/dye-print-orders';
import { handleMaterialIssueEvent, isMaterialIssueDialogOpen, } from '../pages/material-issue';
import { handleQcRecordsEvent } from '../pages/qc-records';
import { handleDeductionAnalysisEvent } from '../pages/deduction-analysis';
import { handleStatementsEvent, isStatementsDialogOpen, } from '../pages/statements';
import { handleAdjustmentsEvent } from '../pages/adjustments';
import { handleBatchesEvent, isBatchesDialogOpen, } from '../pages/batches';
import { handleMaterialStatementsEvent, isMaterialStatementsDialogOpen, } from '../pages/material-statements';
import { handlePaymentSyncEvent, isPaymentSyncDialogOpen, } from '../pages/payment-sync';
import { handleHistoryEvent } from '../pages/history';
import { handleDispatchBoardEvent, isDispatchBoardDialogOpen, } from '../pages/dispatch-board';
import { handleDispatchTendersEvent, isDispatchTendersDialogOpen, } from '../pages/dispatch-tenders';
import { handleProgressBoardEvent, isProgressBoardDialogOpen, } from '../pages/progress-board';
import { handleProgressExceptionsEvent, isProgressExceptionsDialogOpen, } from '../pages/progress-exceptions';
import { handleProgressUrgeEvent, isProgressUrgeDialogOpen, } from '../pages/progress-urge';
import { handleProgressHandoverEvent, isProgressHandoverDialogOpen, } from '../pages/progress-handover';
import { handleProgressHandoverOrderEvent } from '../pages/progress-handover-order';
import { handleProgressMaterialEvent, isProgressMaterialDrawerOpen, } from '../pages/progress-material';
import { handleProgressCuttingOverviewEvent, isProgressCuttingOverviewDialogOpen, } from '../pages/progress-cutting-overview';
import { handleProgressCuttingDetailEvent } from '../pages/progress-cutting-detail';
import { handleProgressCuttingExceptionCenterEvent, isProgressCuttingExceptionCenterDialogOpen, } from '../pages/progress-cutting-exception-center';
import { handleCuttingSettlementInputEvent, isCuttingSettlementInputDialogOpen, } from '../pages/settlement-cutting-input';
import { handleProgressMilestoneConfigEvent, isProgressMilestoneConfigDialogOpen, } from '../pages/progress-milestone-config';
import { handleCraftCuttingProductionProgressEvent, isCraftCuttingProductionProgressDialogOpen, } from '../pages/process-factory/cutting/production-progress';
import { handleCraftCuttingCuttablePoolEvent } from '../pages/process-factory/cutting/cuttable-pool';
import { handleCraftCuttingMarkerPlanEvent, isCraftCuttingMarkerPlanDialogOpen, } from '../pages/process-factory/cutting/marker-plan';
import { handleCraftCuttingMarkerSpreadingEvent, isCraftCuttingMarkerSpreadingDialogOpen, } from '../pages/process-factory/cutting/marker-spreading';
import { handleCraftCuttingFeiTicketsEvent } from '../pages/process-factory/cutting/fei-tickets';
import { handleCraftCuttingCutOrdersEvent, isCraftCuttingCutOrdersDialogOpen, } from '../pages/process-factory/cutting/cut-orders';
import { handleCraftCuttingReplenishmentEvent, isCraftCuttingReplenishmentDialogOpen, } from '../pages/process-factory/cutting/replenishment';
import { handleCraftCuttingSpecialProcessesEvent, isCraftCuttingSpecialProcessesDialogOpen, } from '../pages/process-factory/cutting/special-processes';
import { handleCraftCuttingSampleWarehouseEvent, isCraftCuttingSampleWarehouseDialogOpen, } from '../pages/process-factory/cutting/sample-warehouse';
import { handleCraftCuttingTransferBagsEvent } from '../pages/process-factory/cutting/transfer-bags';
import { handleCraftCuttingSummaryEvent, isCraftCuttingSummaryDialogOpen, } from '../pages/process-factory/cutting/cutting-summary';
...
import { closeFactoryWarehouseSharedDialogs, handleFactoryWarehouseSharedEvent, } from '../pages/process-factory/shared/warehouse-standard';
export async function dispatchFcsPageEvent(target) {
    const pathname = typeof window !== 'undefined' ? window.location.pathname : '';
    if (pathname.startsWith('/fcs/factories/profile')) {
        return handleFactoryPageEvent(target);
    }
    const isPostFinishingRoute = pathname.includes('/fcs/craft/post-finishing');
    if (isPostFinishingRoute
        && target.closest('[data-post-finishing-action], [data-process-web-status-action]')) {
        return handlePostFinishingEvent(target);
    }
    const isSpecialCraftRoute = pathname.includes('/fcs/process-factory/special-craft') ||
        pathname.includes('/fcs/craft/special-craft');
    if (isSpecialCraftRoute
        && target.closest([
        ...
        return (handleSpecialCraftTaskOrdersEvent(target) ||
            handleSpecialCraftWarehouseEvent(target) ||
            handleSpecialCraftWorkOrderDetailEvent(target));
    }
    return (await handleCraftPrintingEvent(target) ||
...
export function dispatchFcsPageSubmit(form) {
    return (handleFactoryPageSubmit(form) ||
        handleCapabilitySubmit(form) ||
        handleSettlementSubmit(form) ||
        handleProductionSubmit(form));
}
export function closeFcsDialogsOnEscape() {

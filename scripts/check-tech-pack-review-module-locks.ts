...
assert.equal(lockedMappingHtml.includes('新增映射行'), false, '版师审核中款色用料对应应隐藏新增映射行入口')
assert.equal(lockedMappingHtml.includes('data-tech-field="mapping-remark"'), false, '版师审核中款色用料对应应切换为只读展示')

...
try {
  ...
  await page.locator(`[data-${config.fieldPrefix}-field="sourceFilter"]`).selectOption('STOCK')
  ...
  await page.locator(`[data-${config.fieldPrefix}-field="sourceFilter"]`).selectOption('')
  ...
  await sourceSetting.locator(`input[data-${config.listPrefix}-action="toggle-column-freeze"]`).check()
  ...
  await page.locator(`[data-${config.listPrefix}-column-key="risk"]`).first().locator(`input[data-${config.listPrefix}-action="toggle-column-visibility"]`).uncheck()

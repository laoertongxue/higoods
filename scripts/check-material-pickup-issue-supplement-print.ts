...
assertIncludes(materialPrepPage, 'window.open', '裁床配料单必须保留新窗口打印能力')
assertIncludes(printIssueListBody, 'openPrintPreviewWindow', '裁床配料单必须通过统一 helper 打开打印预览')
assertIncludes(printIssueListBody, 'buildMaterialPrepSlipPrintLink', '裁床配料单必须继续走统一打印预览链接')

...
const style = {
  ...
  targetChannelCodes: ['independent-site'],
...
assert.ok(listHtml.includes('待审核：买手：买手A、版师：版师B'), '列表应显示待审核指定人')
assert.ok(listHtml.includes('飞书：买手：已发送 / 今日未提醒；版师：已发送 / 今日未提醒'), '列表应显示待审核人的飞书通知状态')
...
assert.ok(overviewHtml.includes('待审核：买手：买手A、版师：版师B'), '款式详情概览应显示待审核指定人')
assert.ok(overviewHtml.includes('飞书：买手：已发送 / 今日未提醒；版师：已发送 / 今日未提醒'), '款式详情概览应显示飞书通知状态')

...
export const AUX_SPECIAL_ACCESSORY_CHAINS: AuxSpecialAccessoryChain[] = [
  ...
  craftChain({ id: 'AUX-14', name: '布包扣', operationId: 'AUX-OP-COVERED-BUTTON-MAKING', craftCode: 'CRAFT_032768', expectedTargetObject: '辅料', inputUnit: 'BOM单位', outputUnit: '个', factoryId: 'FAC-APF', specialCount: 6 }),

...
assertCoverage(
  '印花',
  ['待花型', '等打印', '打印中', '转印中', '待交出', '交出待收货', '收货确认中', '收货差异', '已完成'],
  (status) => mapPrintStatusToPlatformStatus(status),
  ['准备中', '加工中', '待交出', '交出待收货', '收货确认中', '收货差异', '已完成'],
)

assertCoverage(
  '染色',
  ['待样衣', '待原料', '打样中', '待排缸', '染色中', '脱水中', '烘干中', '定型中', '打卷中', '包装中', '包装完成', '交出待收货', '收货确认中', '数量差异', '已完成'],
...
assertCoverage(
  '裁片',
  ['待配料', '部分配料', '待领料', '待唛架', '待铺布', '裁剪中', '待菲票', '待入仓', '已入仓', '待交出', '交出待收货', '收货确认中', '有差异', '已完成'],
  (status) => mapCuttingStatusToPlatformStatus(status),
  ['准备中', '加工中', '待交出', '交出待收货', '收货确认中', '异常', '已完成'],
)

assertCoverage(
  '特殊工艺',
  ['待接收', '已接收', '待加工', '加工中', '加工完成', '待交出', '交出待收货', '收货确认中', '差异待处理', '已完成'],

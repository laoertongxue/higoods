...
import { closeCraftDyeingWaterSolubleOverlay, handleCraftDyeingWaterSolubleOrdersEvent } from '../src/pages/process-factory/dyeing/water-soluble-orders.ts'
...
function actionTarget(action: string, orderId: string): HTMLElement {
  const actionNode = { dataset: { factoryWaterSolubleAction: action, orderId } }
...
handleCraftDyeingWaterSolubleOrdersEvent(actionTarget('confirm-completion', invalidOrder.waterOrderId))
...
handleCraftDyeingWaterSolubleOrdersEvent(actionTarget('confirm-completion', shortOrder.waterOrderId))
...
handleCraftDyeingWaterSolubleOrdersEvent(actionTarget('confirm-completion', overOrder.waterOrderId))
...
handleCraftDyeingWaterSolubleOrdersEvent(actionTarget('confirm-completion', overOrder.waterOrderId))
handleCraftDyeingWaterSolubleOrdersEvent(actionTarget('confirm-completion-overage', overOrder.waterOrderId))

...
assertRowsSortedByDueDate(productionSnapshots)
...
assertContains(progressBoardSource, '任务进度跟踪', '任务进度页面必须使用新名称')
assertNotContains(progressBoardSource, '任务进度看板', '任务进度页面不得继续显示旧名称')
assertNotContains(progressBoardSource, 'switch-dimension', '任务进度页面不得保留生产单维度切换')
assertNotContains(progressBoardSource, 'switch-view', '任务进度页面不得保留列表/看板切换')

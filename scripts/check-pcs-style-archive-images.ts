...
assertIncludes(contract, 'styleMainImageId', '完善商品档案主图字段')
assertIncludes(contract, 'styleGalleryImageIds', '完善商品档案图册字段')
assertIncludes(contract, 'styleImageSource', '完善商品档案图片来源字段')
assertIncludes(contract, 'styleImageConfirmedAt', '完善商品档案确认时间字段')
assertIncludes(contract, 'styleImageConfirmedBy', '完善商品档案确认人字段')
...
assertNotIncludes(generation, 'buildStyleFixture', '新完善商品档案默认 fixture 图片逻辑')
assertNotIncludes(generation, 'fixture.mainImageUrl', '新完善商品档案默认主图')
assertNotIncludes(generation, 'fixture.galleryImageUrls', '新完善商品档案默认图册')

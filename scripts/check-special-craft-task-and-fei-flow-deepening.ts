...
assertContains(taskOrdersPageSource, '打印任务流转卡', '特殊工艺加工单列表缺少打印任务流转卡入口')
...
assertContains(renderSpecialCraftDomainWaitHandoverWarehousePage(warehouseDomainSlug(sampleOperation)), '打印任务交货卡', '特殊工艺待交出仓渲染结果缺少打印任务交货卡')

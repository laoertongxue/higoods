...
assertContains(taskOrdersPageSource, '打印流转卡', '特殊工艺加工单列表缺少打印流转卡入口')
assertContains(taskOrdersPageSource, "buildTaskRouteCardPrintLink('SPECIAL_CRAFT_TASK_ORDER', taskOrder.taskOrderId)", '特殊工艺加工单列表打印必须使用 taskOrderId')
...
assertContains(workOrderDetailPageSource, '加工单详情', '缺少加工单详情页')
assertContains(workOrderDetailPageSource, '流转事件', '子加工单详情必须展示流转事件')
assertContains(workOrderDetailPageSource, "objectMeta.objectType === '裁片'", '加工单详情必须按作用对象隔离菲票')
assertContains(workOrderDetailPageSource, '无需菲票', '成衣加工单详情必须明确无需菲票')

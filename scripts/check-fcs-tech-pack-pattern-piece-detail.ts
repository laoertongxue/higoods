...
assertIncludes(snapshotBuilderSource, 'bundleLengthCm', '技术包快照构建必须保留捆条长度')
assertIncludes(snapshotBuilderSource, 'bundleWidthCm', '技术包快照构建必须保留捆条宽度')
...
assertIncludes(snapshotRuntimeSource, 'bundleLengthCm', '运行时快照克隆必须保留捆条长度')
assertIncludes(snapshotRuntimeSource, 'bundleWidthCm', '运行时快照克隆必须保留捆条宽度')

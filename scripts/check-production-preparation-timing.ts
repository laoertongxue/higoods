...
assertHtmlIncludes(statsHtml, '共 9 条，第 1/2 页', '月度统计列表必须支持分页')
assertHtmlIncludes(
  statsHtml,
...
assertHtmlIncludes(detailStatsHtml, '共 16 条，第 1/2 页', '明细统计列表必须支持分页')
...
assertHtmlIncludes(monthlyPage2Html, '共 9 条，第 2/2 页', '月度统计第 2 页必须展示分页状态')
...
assertHtmlIncludes(detailPage2Html, '共 16 条，第 2/2 页', '明细统计第 2 页必须展示分页状态')

...
assert.equal(canEditTechnicalModule(current, 'COLOR_MATERIAL_MAPPING'), false, '版师审核中款色用料对应锁定')
current = approveTechPackReview(technicalVersionId, 'PATTERN_MAKER', '纸样和映射通过', '版师B')

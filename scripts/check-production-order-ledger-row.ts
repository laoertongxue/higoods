...
assert(!listHtml.includes('<th class="min-w-[230px] px-3 py-3 text-left font-medium">配料 / 接收</th>'), '生产单管理不得展示配料 / 接收列')
...
;['1）配料 / 接收明细', '2）任务单 / 工厂明细', '3）关键时间明细', '4）数量 / 质量明细'].forEach((title) => {

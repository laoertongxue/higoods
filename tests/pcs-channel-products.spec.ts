...
assert.match(detailHtml, /商品档案 \/ 渠道店铺商品 \/ 项目测款来源/, '详情页应渲染面包屑')
...
assert.match(detailHtml, /渠道店铺商品状态口径/, '详情页应渲染状态口径区域')
assert.match(detailHtml, /项目 \/ 款式 \/ 规格 \/ 渠道关联结果/, '详情页应渲染关联结果区域')
...
assert.match(detailHtml, /已生效已更新|已生效待更新|已上架待测款|待上架|已作废/, '详情页应展示统一业务状态标签')

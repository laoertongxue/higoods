...
const sampleConfirmNode = getProjectNodeRecordByStepCode(sampleConfirmProject!.projectId, 'SAMPLE_CONFIRM')
const nextExecutionNodeBefore = getProjectNodeRecordByStepCode(sampleConfirmProject!.projectId, 'SAMPLE_COST_REVIEW')
...
assert.ok(result.ok)
assert.equal(getProjectNodeRecordByStepCode(sampleConfirmProject!.projectId, 'SAMPLE_CONFIRM')?.currentStatus, '已完成')
assert.equal(getProjectNodeRecordByStepCode(sampleConfirmProject!.projectId, 'SAMPLE_COST_REVIEW')?.currentStatus, '进行中')

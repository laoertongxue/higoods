...
test('BOM dictionary preserves old JSON and all snapshot values without mutating input',()=>{
 const value={version:2,records:Array.from({length:134},(_,i)=>({id:`BOM-${i}`,ownerId:'ES-ID-DR-001',styleCode:'STYLE-PRJ-202603-012',styleImageUrl:'/dress-sample-1.jpg',customCosts:[{title:'车位费',amount:12000}],materialLines:[{usage:1.25,optional:undefined,items:[undefined,NaN,Infinity,-Infinity],flag:false,note:null}]})),plans:[]}

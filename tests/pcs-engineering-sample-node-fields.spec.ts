...
const plateHtml = renderPcsProjectWorkItemDetailPage(project014!.projectId, plateNode!.projectNodeId)
...
const artworkHtml = renderPcsProjectWorkItemDetailPage(project013!.projectId, artworkNode!.projectNodeId)
...
const firstSampleHtml = renderPcsProjectWorkItemDetailPage(project013!.projectId, firstSampleNode!.projectNodeId)
...
const preProductionHtml = renderPcsProjectWorkItemDetailPage(project013!.projectId, preProductionNode!.projectNodeId)

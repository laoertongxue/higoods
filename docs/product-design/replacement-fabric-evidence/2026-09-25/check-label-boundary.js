async page=>{
 const c=await page.context().browser().newContext({viewport:{width:1024,height:768}}),p=await c.newPage();await p.goto('http://127.0.0.1:43225/fcs/craft/cutting/replacement-fabric-fei-tickets');await p.locator('[data-hpb-page]').waitFor();

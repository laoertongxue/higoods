async root=>{
 ...
 await p.locator('[data-marker-plan-bed-field=remark]').first().press('Tab');await p.evaluate(()=>new Promise(r=>requestAnimationFrame(()=>requestAnimationFrame(r))));
 steps.push('filled');

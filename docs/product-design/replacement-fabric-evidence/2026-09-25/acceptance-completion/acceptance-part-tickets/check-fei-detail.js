...
const c=await browser.newContext({viewport:{width:1366,height:768}}),p=await c.newPage(),errors=[];p.on('pageerror',e=>errors.push(String(e)));
...
const detailUrl='http://127.0.0.1:43236/fcs/craft/cutting/fei-tickets/'+encodeURIComponent('spreading:'+manual[0].value.manualBatchId);

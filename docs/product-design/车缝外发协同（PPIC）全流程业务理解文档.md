...
| 批版人员 | 接收PPIC转交的产前版样衣，结合公司自制／留存样衣、生产单图片、纸样、面料和辅料等资料核对；记录“无问题”或“有问题＋具体建议”，并把批版建议上传系统 | 不代替 PPIC 做日常工厂履约跟进；不修改裁片、回货或结算事实 |
...
PPIC接收产前版样衣后，把实物交给批版人员。批版人员结合公司内部已制作／留存的样衣、生产单图片、纸样、面料、辅料等资料进行核对，判断这件衣服是否存在问题。批版人员在系统中形成的结论和具体建议，才叫**批版建议**。
...
- **有问题**：必须逐项记录问题部位、问题描述和具体生产建议，必要时附标注图片。

“有问题”不能自动等同于“批版不通过”或“必须重新制作一件样衣”。按本次业务说明，批版人员上传具体建议后，PPIC即可查看并截图发给外发工厂，工厂按建议生产大货。只有批版人员明确要求重新做版／再次批版时，才增加下一次记录；系统不得把此前未经确认的“有问题就强制整改、重新送审、通过后才能生产”固化成统一流程。

批版建议记录至少包含：建议单号、执行任务、工厂、PPIC、产前版样衣标识及照片、送回与转交时间、批版人员、引用资料及版本、结论、问题部位、具体建议、标注图片、上传时间和PPIC反馈时间。

系统需要提供适合截图的批版建议卡片：清楚显示生产单／款号、工厂、款式与产前版样衣图片、结论、具体建议、批版人员和时间，不把内部技术字段堆在截图主体中。系统本轮不代替即时通讯发送，PPIC仍按现场方式截图并发给外发工厂。
...
退仓数量不能直接冲减工厂回货责任；它首先影响裁片责任和库存，是否影响应回成衣需要根据退回裁片能否组成原有效齐套数量重新计算，并保留版本变化。
...
- **批版建议异常**：产前版样衣已送回但未及时交给批版人员、批版建议未上传、问题没有具体建议或PPIC尚未反馈工厂。
...
**预期：** 批版结论记录为“有问题”，逐项记录问题部位和具体生产建议并上传。PPIC可以直接打开适合截图的批版建议卡片，截图发给外发工厂；工厂按建议生产大货。系统不自动把它变成“批版不通过／必须重新送审”，只有批版人员明确要求再次批版时才追加下一次记录。
...
| SAMPLE-003 | 批版结论为“无问题”或“有问题”；有问题时必须给出具体生产建议并上传系统 | 本轮业务原话 | 已确认 |
...
7. 三方车缝工厂制作并送回的第一件大货产前版实物才是产前版样衣；PPIC转交批版人员后形成的系统节点和记录叫批版建议。批版人员上传“无问题”或“有问题＋具体建议”，PPIC截图反馈工厂；PCS当前同名对象实为首单样衣，必须区分并更名。

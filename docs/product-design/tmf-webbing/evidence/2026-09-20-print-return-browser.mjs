...
try{
 ...
 await page.screenshot({path:'output/playwright/tmf-webbing/print-return.png',fullPage:true})
 assert.deepEqual(evidence.errors,[])
}finally{writeFileSync('output/playwright/tmf-webbing/print-return-browser.json',JSON.stringify(evidence,null,2));await browser.close()}

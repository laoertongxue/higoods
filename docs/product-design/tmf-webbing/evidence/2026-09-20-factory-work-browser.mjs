...
function productionSource(id) {
 ...
 evidence.checks.push('同生产快照/路线两规格归为一张加工单；页面实收投入、截断、装包、交出；错SKU/超耗料/超装包/未核实阻断；刷新保留且交出未提前实收')
 await page.goto('http://127.0.0.1:43188/wls/accessory-receipts')
...
finally{writeFileSync('output/playwright/tmf-webbing/factory-work-evidence.json',JSON.stringify(evidence,null,2));await browser.close()}

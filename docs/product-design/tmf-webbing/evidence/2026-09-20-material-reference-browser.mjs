...
const evidence={route:'/pcs/products/styles/style_seed_project_018/technical-data/tdv_seed_project_018_review_skip_demo',viewport:{width:1366,height:768},checks:[],errors:[]}
try {
...
finally {writeFileSync('output/playwright/tmf-webbing/editor-save-evidence.json',JSON.stringify(evidence,null,2));await browser.close()}

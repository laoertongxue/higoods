...
- Name: pcs-design-revision-pda-receiving.spec.ts >> PDA print-dispatched 按原卷实收、刷新可读且重复扫码不能重复入库
...
```yaml
- text: 当前接收人：goto_global / goto_global_操作工
- alert
- main:
  - text: 1 扫码识别 →
  - strong: 2 核对实物并填写
  ...
  - paragraph: 接收人：goto_global / goto_global_操作工。只保存勾选并填写的行；未收到请明确选择零接收。
  - text: 本次统一库位
  - combobox "本次统一库位":
    - option "请选择本厂已启用的库位"
    - option "goto_global · 待加工仓 / A区 / A-01-01" [selected]
    - option "goto_global · 待加工仓 / A区 / A-01-02"
    - option "goto_global · 待加工仓 / B区 / B-01-01"
    - option "goto_global · 待加工仓 / B区 / B-01-02"
    - option "goto_global · 待加工仓 / C区 / C-01-01"
    - option "goto_global · 待加工仓 / C区 / C-01-02"
    - option "goto_global · 待加工仓 / D区 / D-01-01"
    - option "goto_global · 待加工仓 / D区 / D-01-02"
    - option "goto_global · 待加工仓 / E区 / E-01-01"
    - option "goto_global · 待加工仓 / E区 / E-01-02"
    - option "goto_global · 待加工仓 / F区 / F-01-01"
    - option "goto_global · 待加工仓 / F区 / F-01-02"
    - option "goto_global · 待加工仓 / 异常区 / 异常-01-01"
    - option "goto_global · 待加工仓 / 异常区 / 异常-01-02"
    - option "goto_global · 待加工仓 / 待确认区 / 待确认-01-01"
    - option "goto_global · 待加工仓 / 待确认区 / 待确认-01-02"
  - button "应用到全部明细和卷"
  - heading "HDO-NTAUTO000001 · FLOWER" [level=2]
  - checkbox "登记这一行"
  - text: 登记这一行
  - button "查看设计改款白底蓝花棉布大图":
    - img "设计改款白底蓝花棉布 White"
  - strong: 设计改款白底蓝花棉布
  - text: DR-COTTON-001-WHITE-BLUE-PRINT White 面料 · 100% 棉 棉布 / 幅宽 150 cm / 克重 180 g/㎡ 批次：SJ-20260924-1790191302488-10
  - group: 查看上游参考数量
  - checkbox "本行整批未收到（明确登记 0 卷 / 0 Yard）"
  - text: 本行整批未收到（明确登记 0 卷 / 0 Yard）
  - checkbox "M_20260923000001_PH-20260923-000001_0002"
  - text: M_20260923000001_PH-20260923-000001_0002 实收 Yard
  - spinbutton "实收 Yard"
  - text: 本卷库位
  - combobox "本卷库位":
    - option "请选择本厂已启用的库位"

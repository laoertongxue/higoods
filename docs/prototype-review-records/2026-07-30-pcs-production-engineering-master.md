...
- 制版与花型任务关联商品项目时，只关联真实商品项目和“项目固定步骤”来源，不再查找、更新或保存已删除的专业项目节点。
- “关联商品项目”创建方式强制来源为“项目固定步骤”；“独立任务”创建方式强制来源为“人工创建”。页面选择、事件处理和提交参数三处采用同一门禁。
...
| 中文化 | 通过。公开语义统一为“项目固定步骤”“项目步骤”“任务状态”。 |
| 例外 | 无。 |

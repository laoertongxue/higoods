...
- 印花的主加工对象必须继承来源 BOM 原物料类别，例如面料、花边、织带等；已按纸样裁开的衣片不是印花对象。
- 染色也必须继承具体 BOM 原物料类别和实际计量单位；面料可按米数/卷数，纱线、花边等不得强制改写成面料米数。
- 裁片执行口径使用“裁片数量”；生产单和 SKU 计划可以展示“成衣件数”，但不得替代裁片执行数量。
- 特殊工艺执行口径使用“裁片数量”，菲票绑定和差异使用“菲票数量”。
- 页面、弹窗、移动端、打印、统计、操作记录不得只写“数量”；必须展示“计划印花面料米数”“转印完成花边米数”“染色交出卷数”“绑定菲票数量”等对象化文案。

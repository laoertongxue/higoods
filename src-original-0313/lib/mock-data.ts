  ...
  fcs: [
    ...
    // FCS 菜单基线更新：因"任务分配方式"与"任务分配看板"业务边界高度重叠，已收口为统一入口"任务分配"；当前菜单继续冻结，非必要不再调整。
    {
      ...
      items: [
        ...
        { key: 'dispatch-award', title: '定标', icon: 'BadgeCheck', href: '/fcs/dispatch/award' },
    ...
    },
    {
      title: '工厂端（PDA）',
      items: [
        { key: 'pda-task-receive', title: '任务接收与确认', icon: 'Smartphone', href: '/fcs/pda/task-receive' },
        { key: 'pda-exec', title: '生产执行与交接', icon: 'Smartphone', href: '/fcs/pda/exec' },
        { key: 'pda-notify', title: '质量与结算', icon: 'Smartphone', href: '/fcs/pda/notify' },
      ],
    },
  ],
  wls: [

...
export const QC_SEEDS: QualityInspection[] = [
  ...
  // ── FAIL 10 条 ── disposition 覆盖 REWORK/REMAKE/ACCEPT_AS_DEFECT/SCRAP ──
  // REWORK × 3
  { qcId: 'QC-009', refType: 'TASK', refId: 'TASK-0001-003', productionOrderId: 'PO-0001', inspector: '张三', inspectedAt: '2026-02-18 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D001', defectName: '车线跳针', qty: 80 }, { defectCode: 'D002', defectName: '尺寸偏差', qty: 40 }], remark: '需全部返工', status: 'SUBMITTED', disposition: 'REWORK', affectedQty: 120, rootCauseType: 'PROCESS', responsiblePartyType: 'FACTORY', responsiblePartyId: SEED_FACTORY_ID, liabilityStatus: 'CONFIRMED', generatedTaskIds: ['TASK-SEED-0001'], auditLogs: [{ id: 'AL-QC-009-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL，处置=REWORK', at: '2026-02-18 10:00:00', by: '张三' }, { id: 'AL-QC-009-2', action: 'GENERATE_REWORK_TASK', detail: '生成返工任务 TASK-SEED-0001', at: '2026-02-18 10:01:00', by: 'SYSTEM' }], createdAt: '2026-02-18 09:00:00', updatedAt: '2026-02-18 10:01:00' },
  { qcId: 'QC-010', refType: 'TASK', refId: 'TASK-0002-003', productionOrderId: 'PO-0002', inspector: '李四', inspectedAt: '2026-02-19 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D003', defectName: '染色不均', qty: 50 }], remark: '局部返工', status: 'SUBMITTED', disposition: 'REWORK', affectedQty: 50, rootCauseType: 'DYE_PRINT', responsiblePartyType: 'PROCESSOR', responsiblePartyId: 'PROC-DP-001', liabilityStatus: 'DISPUTED', auditLogs: [{ id: 'AL-QC-010-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL，处置=REWORK', at: '2026-02-19 10:00:00', by: '李四' }], createdAt: '2026-02-19 09:00:00', updatedAt: '2026-02-19 10:00:00' },
  { qcId: 'QC-011', refType: 'TASK', refId: 'TASK-0005-002', productionOrderId: 'PO-0005', inspector: '王五', inspectedAt: '2026-02-20 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D004', defectName: '绣花错位', qty: 30 }], remark: '', status: 'SUBMITTED', disposition: 'REWORK', affectedQty: 30, rootCauseType: 'PROCESS', responsiblePartyType: 'FACTORY', responsiblePartyId: 'ID-F002', liabilityStatus: 'DISPUTED', auditLogs: [{ id: 'AL-QC-011-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL，处置=REWORK', at: '2026-02-20 10:00:00', by: '王五' }], createdAt: '2026-02-20 09:00:00', updatedAt: '2026-02-20 10:00:00' },
  // REMAKE × 2
  { qcId: 'QC-012', refType: 'TASK', refId: 'TASK-0007-002', productionOrderId: 'PO-0007', inspector: '赵六', inspectedAt: '2026-02-21 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D005', defectName: '版型错误', qty: 200 }], remark: '整批重做', status: 'SUBMITTED', disposition: 'REMAKE', affectedQty: 200, rootCauseType: 'PATTERN_TECH', responsiblePartyType: 'OTHER', responsiblePartyId: 'OTHER-001', liabilityStatus: 'CONFIRMED', auditLogs: [{ id: 'AL-QC-012-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL，处置=REMAKE', at: '2026-02-21 10:00:00', by: '赵六' }], createdAt: '2026-02-21 09:00:00', updatedAt: '2026-02-21 10:00:00' },
  { qcId: 'QC-013', refType: 'TASK', refId: 'TASK-0009-002', productionOrderId: 'PO-0009', inspector: '张三', inspectedAt: '2026-02-22 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D006', defectName: '面料起球', qty: 100 }], remark: '面料原因，整批重做', status: 'SUBMITTED', disposition: 'REMAKE', affectedQty: 100, rootCauseType: 'MATERIAL', responsiblePartyType: 'SUPPLIER', responsiblePartyId: 'SUP-001', liabilityStatus: 'DISPUTED', auditLogs: [{ id: 'AL-QC-013-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL，处置=REMAKE', at: '2026-02-22 10:00:00', by: '张三' }], createdAt: '2026-02-22 09:00:00', updatedAt: '2026-02-22 10:00:00' },
  // ACCEPT_AS_DEFECT × 2
  ...
  // HANDOVER refType × 1
  { qcId: 'QC-018', refType: 'HANDOVER', refId: 'HO-2026-001', productionOrderId: 'PO-0005', inspector: '李四', inspectedAt: '2026-02-27 10:00:00', result: 'FAIL', defectItems: [{ defectCode: 'D011', defectName: '交货数量不符', qty: 35 }], remark: '交接差异', status: 'SUBMITTED', disposition: 'REWORK', affectedQty: 35, rootCauseType: 'PROCESS', responsiblePartyType: 'FACTORY', responsiblePartyId: 'ID-F003', liabilityStatus: 'DISPUTED', auditLogs: [{ id: 'AL-QC-018-1', action: 'SUBMIT_QC', detail: '提交质检结果 FAIL（交接），处置=REWORK', at: '2026-02-27 10:00:00', by: '李四' }], createdAt: '2026-02-27 09:00:00', updatedAt: '2026-02-27 10:00:00' },
  // extra pass
...
export const seedParentTask: ProcessTask = {
  ...
  status: 'BLOCKED',
  blockReason: 'QUALITY',
  blockRemark: '质检 QC-SEED-0001 发现严重缺陷，待返工完成后解锁',
  blockedAt: SEED_AT,
...
export const seedReworkTask: ProcessTask = {
  taskId: 'TASK-REWORK-SEED-0001',
  productionOrderId: 'PO-SEED-0001',
  seq: 2,
  processCode: 'PROC_REWORK',
  processNameZh: '返工',
  stage: 'SEWING',
  qty: 120,
  qtyUnit: 'PIECE',
  ...
  parentTaskId: 'TASK-SEED-0001',
  sourceQcId: 'QC-SEED-0001',
  sourceTaskId: 'TASK-SEED-0001',
  sourceProductionOrderId: 'PO-SEED-0001',
  taskKind: 'REWORK',
  taskCategoryZh: '返工',
  createdAt: SEED_AT,
  updatedAt: SEED_AT,
  auditLogs: [
    { id: 'AL-REWORK-SEED-001', action: 'CREATE_REWORK_TASK', detail: '由 QC-SEED-0001 FAIL+返工处置自动生成', at: SEED_AT, by: 'SYSTEM' },
  ],
}
...
export const BASIS_SEEDS: DeductionBasisItem[] = [
  ...
  { basisId: 'DBI-001', sourceType: 'QC_FAIL', sourceRefId: 'QC-009', sourceId: 'QC-009', productionOrderId: 'PO-0001', taskId: 'TASK-0001-003', factoryId: SEED_FACTORY_ID, settlementPartyType: 'FACTORY', settlementPartyId: SEED_FACTORY_ID, rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 120, uom: 'PIECE', disposition: 'REWORK', summary: '车线跳针+尺寸偏差，返工120件', evidenceRefs: [], status: 'CONFIRMED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-009', taskHref: '/fcs/pda/task-receive/TASK-0001-003' }, createdAt: '2026-02-18 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-001-1', action: 'CREATE_BASIS_FROM_QC', detail: '由 QC-009 FAIL 生成', at: '2026-02-18 10:01:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-002', sourceType: 'QC_FAIL', sourceRefId: 'QC-010', sourceId: 'QC-010', productionOrderId: 'PO-0002', taskId: 'TASK-0002-003', factoryId: 'ID-F002', settlementPartyType: 'PROCESSOR', settlementPartyId: 'PROC-DP-001', rootCauseType: 'DYE_PRINT', reasonCode: 'QUALITY_FAIL', qty: 50, uom: 'PIECE', disposition: 'REWORK', summary: '染色不均，返工50件', evidenceRefs: [], status: 'DISPUTED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-010', taskHref: '/fcs/pda/task-receive/TASK-0002-003' }, createdAt: '2026-02-19 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-002-1', action: 'CREATE_BASIS_FROM_QC', detail: '由 QC-010 FAIL 生成', at: '2026-02-19 10:01:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-003', sourceType: 'QC_FAIL', sourceRefId: 'QC-011', sourceId: 'QC-011', productionOrderId: 'PO-0005', taskId: 'TASK-0005-002', factoryId: 'ID-F002', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F002', rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 30, uom: 'PIECE', disposition: 'REWORK', summary: '绣花错位，返工30件', evidenceRefs: [], status: 'DISPUTED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-011', taskHref: '/fcs/pda/task-receive/TASK-0005-002' }, createdAt: '2026-02-20 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-003-1', action: 'CREATE_BASIS_FROM_QC', detail: '由 QC-011 FAIL 生成', at: '2026-02-20 10:01:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-004', sourceType: 'QC_FAIL', sourceRefId: 'QC-012', sourceId: 'QC-012', productionOrderId: 'PO-0007', taskId: 'TASK-0007-002', factoryId: 'ID-F003', settlementPartyType: 'OTHER', settlementPartyId: 'OTHER-001', rootCauseType: 'PATTERN_TECH', reasonCode: 'QUALITY_FAIL', qty: 200, uom: 'PIECE', disposition: 'REMAKE', summary: '版型错误，重做200件', evidenceRefs: [], status: 'CONFIRMED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-012', taskHref: '/fcs/pda/task-receive/TASK-0007-002' }, createdAt: '2026-02-21 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-004-1', action: 'CREATE_BASIS_FROM_QC', detail: '由 QC-012 FAIL 生成', at: '2026-02-21 10:01:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-005', sourceType: 'QC_FAIL', sourceRefId: 'QC-013', sourceId: 'QC-013', productionOrderId: 'PO-0009', taskId: 'TASK-0009-002', factoryId: 'ID-F004', settlementPartyType: 'SUPPLIER', settlementPartyId: 'SUP-001', rootCauseType: 'MATERIAL', reasonCode: 'QUALITY_FAIL', qty: 100, uom: 'PIECE', disposition: 'REMAKE', summary: '面料起球，重做100件', evidenceRefs: [], status: 'DISPUTED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-013', taskHref: '/fcs/pda/task-receive/TASK-0009-002' }, createdAt: '2026-02-22 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-005-1', action: 'CREATE_BASIS_FROM_QC', detail: '由 QC-013 FAIL 生成', at: '2026-02-22 10:01:00', by: 'SYSTEM' }] },
  ...
  // HANDOVER_DIFF
  { basisId: 'DBI-009', sourceType: 'HANDOVER_DIFF', sourceRefId: 'HO-2026-001', sourceId: 'HO-2026-001', productionOrderId: 'PO-0005', refHandoverId: 'HO-2026-001', factoryId: 'ID-F003', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F003', rootCauseType: 'PROCESS', reasonCode: 'HANDOVER_SHORTAGE', qty: 35, uom: 'PIECE', disposition: 'REWORK', summary: '交接数量短缺35件', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-018', handoverHref: '/fcs/pda/handover/HO-2026-001' }, createdAt: '2026-02-27 10:01:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-009-1', action: 'CREATE_BASIS_FROM_HANDOVER', detail: '由 HO-2026-001 交接差异生成', at: '2026-02-27 10:01:00', by: 'SYSTEM' }] },
  ...
  { basisId: 'DBI-011', sourceType: 'QC_FAIL', sourceRefId: 'QC-009-B', sourceId: 'QC-009-B', productionOrderId: 'PO-0001', taskId: 'TASK-0001-003', factoryId: SEED_FACTORY_ID, settlementPartyType: 'FACTORY', settlementPartyId: SEED_FACTORY_ID, rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 25, uom: 'PIECE', disposition: 'REWORK', summary: '二次返工补充依据', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-009' }, createdAt: '2026-02-19 14:00:00', createdBy: '质检员A', auditLogs: [{ id: 'AL-DBI-011-1', action: 'CREATE_BASIS_FROM_QC', detail: '补充依据', at: '2026-02-19 14:00:00', by: '质检员A' }] },
  ...
  { basisId: 'DBI-017', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-004', sourceId: 'QC-NEW-004', productionOrderId: 'PO-BLOCKED', taskId: 'TASK-BLOCKED-001', factoryId: SEED_FACTORY_ID, settlementPartyType: 'FACTORY', settlementPartyId: SEED_FACTORY_ID, rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 90, uom: 'PIECE', disposition: 'REWORK', summary: '版型不符，返工90件', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-004', taskHref: '/fcs/pda/task-receive/TASK-BLOCKED-001' }, createdAt: '2026-02-26 14:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-017-1', action: 'CREATE_BASIS_FROM_QC', detail: '版型问题', at: '2026-02-26 14:00:00', by: 'SYSTEM' }] },
  ...
  { basisId: 'DBI-019', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-006', sourceId: 'QC-NEW-006', productionOrderId: 'PO-0001', taskId: 'TASK-0001-001', factoryId: SEED_FACTORY_ID, settlementPartyType: 'FACTORY', settlementPartyId: SEED_FACTORY_ID, rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 70, uom: 'PIECE', disposition: 'REWORK', summary: '明线外露，返工70件', evidenceRefs: [], status: 'CONFIRMED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-006', taskHref: '/fcs/pda/task-receive/TASK-0001-001' }, createdAt: '2026-02-28 14:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-019-1', action: 'CREATE_BASIS_FROM_QC', detail: '明线问题', at: '2026-02-28 14:00:00', by: 'SYSTEM' }] },
  ...
  { basisId: 'DBI-021', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-007', sourceId: 'QC-NEW-007', productionOrderId: 'PO-0005', taskId: 'TASK-0005-001', factoryId: 'ID-F002', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F002', rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 15, uom: 'PIECE', disposition: 'REWORK', summary: '熨烫不良，返工15件', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-007', taskHref: '/fcs/pda/task-receive/TASK-0005-001' }, createdAt: '2026-03-01 10:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-021-1', action: 'CREATE_BASIS_FROM_QC', detail: '熨烫问题', at: '2026-03-01 10:00:00', by: 'SYSTEM' }] },
  ...
  { basisId: 'DBI-023', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-009', sourceId: 'QC-NEW-009', productionOrderId: 'PO-0002', taskId: 'TASK-0002-002', factoryId: 'ID-F001', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F001', rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 28, uom: 'PIECE', disposition: 'REWORK', summary: '拉链质量差，返工28件', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-009', taskHref: '/fcs/pda/task-receive/TASK-0002-002' }, createdAt: '2026-03-01 12:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-023-1', action: 'CREATE_BASIS_FROM_QC', detail: '拉链问题', at: '2026-03-01 12:00:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-024', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-010', sourceId: 'QC-NEW-010', productionOrderId: 'PO-0009', taskId: 'TASK-0009-004', factoryId: 'ID-F004', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F004', rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 60, uom: 'PIECE', disposition: 'REMAKE', summary: '做工粗糙，整批重做60件', evidenceRefs: [], status: 'CONFIRMED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-010', taskHref: '/fcs/pda/task-receive/TASK-0009-004' }, createdAt: '2026-03-01 13:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-024-1', action: 'CREATE_BASIS_FROM_QC', detail: '做工问题', at: '2026-03-01 13:00:00', by: 'SYSTEM' }] },
  ...
  { basisId: 'DBI-029', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-014', sourceId: 'QC-NEW-014', productionOrderId: 'PO-BLOCKED', taskId: 'TASK-BLOCKED-003', factoryId: SEED_FACTORY_ID, settlementPartyType: 'FACTORY', settlementPartyId: SEED_FACTORY_ID, rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 75, uom: 'PIECE', disposition: 'REWORK', summary: '领口工艺不良，返工75件', evidenceRefs: [], status: 'DISPUTED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-014', taskHref: '/fcs/pda/task-receive/TASK-BLOCKED-003' }, createdAt: '2026-03-02 12:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-029-1', action: 'CREATE_BASIS_FROM_QC', detail: '领口问题', at: '2026-03-02 12:00:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-030', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-015', sourceId: 'QC-NEW-015', productionOrderId: 'PO-0009', taskId: 'TASK-0009-005', factoryId: 'ID-F004', settlementPartyType: 'SUPPLIER', settlementPartyId: 'SUP-001', rootCauseType: 'MATERIAL', reasonCode: 'QUALITY_FAIL', qty: 44, uom: 'PIECE', disposition: 'REMAKE', summary: '辅料不合格，重做44件', evidenceRefs: [], status: 'CONFIRMED', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-015', taskHref: '/fcs/pda/task-receive/TASK-0009-005' }, createdAt: '2026-03-02 13:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-030-1', action: 'CREATE_BASIS_FROM_QC', detail: '辅料问题', at: '2026-03-02 13:00:00', by: 'SYSTEM' }] },
  { basisId: 'DBI-031', sourceType: 'QC_FAIL', sourceRefId: 'QC-NEW-016', sourceId: 'QC-NEW-016', productionOrderId: 'PO-0005', taskId: 'TASK-0005-003', factoryId: 'ID-F002', settlementPartyType: 'FACTORY', settlementPartyId: 'ID-F002', rootCauseType: 'PROCESS', reasonCode: 'QUALITY_FAIL', qty: 22, uom: 'PIECE', disposition: 'REWORK', summary: '裤腿长度偏差，返工22件', evidenceRefs: [], status: 'DRAFT', deepLinks: { qcHref: '/fcs/quality/qc-records/QC-NEW-016', taskHref: '/fcs/pda/task-receive/TASK-0005-003' }, createdAt: '2026-03-03 09:00:00', createdBy: 'SYSTEM', auditLogs: [{ id: 'AL-DBI-031-1', action: 'CREATE_BASIS_FROM_QC', detail: '长度偏差', at: '2026-03-03 09:00:00', by: 'SYSTEM' }] },
